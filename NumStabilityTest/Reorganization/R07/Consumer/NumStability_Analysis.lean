...
imports only NumStability.Analysis and checks its exact 150-declaration historical R07 aggregate frontier after NumStability.Analysis.BergerGeneral->NumStability.Analysis.LinearOperators.NumericalRadius.Berger.GeneralPowerInequality;NumStability.Analysis.BergerInequality->-;NumStability.Analysis.CStarMatrixBridge->-;NumStability.Analysis.CStarMatrixExpectation->-;NumStability.Analysis.CStarMatrixTrace->-;NumStability.Analysis.HenriciSharpConstantExact->-;NumStability.Analysis.LiebTrace->-;NumStability.Analysis.MatrixPowersBinomialBound->NumStability.Analysis.LinearOperators.MatrixPowers.Henrici.SchurBinomialBounds;NumStability.Analysis.MatrixPowersGautschi->-;NumStability.Analysis.MatrixPowersLaszlo->-;NumStability.Analysis.MatrixPowersLp185Primary->-;NumStability.Analysis.MatrixPowersSpijkerClosure->NumStability.Analysis.LinearOperators.MatrixPowers.Spijker.FiniteDimensionalPowerBounds;NumStability.Source.Higham.Chapter18.Section01.MatrixPowerBounds.NamedBounds.SpijkerKreissUnconditional;NumStability.Analysis.NilpotentJordanChain->-;NumStability.Analysis.OperatorLog->-;NumStability.Analysis.PseudospectralLowerBound->-
-/
