...
/-!
# W09 canonical dependency

The Dixon destinations must reach the accepted W09
TestMatrices leaves canonically, never the historical
`Higham28OrthogonalCoordinates` facade.
-/
