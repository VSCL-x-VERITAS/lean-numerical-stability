...
/-!
# R11 historical-only test — `Higham19Thm6ElementwisePackaged`

Imports exactly the historical path `NumStability.Algorithms.QR.Higham19Thm6ElementwisePackaged`
and nothing else.
