...
/-!
# R11 historical-only test — `Sensitivity`

Imports exactly the historical path `NumStability.Source.Higham.Chapter19.Sensitivity`
and nothing else.

Checks the public surface still reachable through that historical path:

* 57 declarations routed from this owner
* 57 at directly imported destination `NumStability.Source.Higham.Chapter19.Sensitivity.Bounds.Results`
