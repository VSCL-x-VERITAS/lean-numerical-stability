...
/-!
# R11 canonical-only test — `Results`

Imports exactly the canonical destination `NumStability.Source.Higham.Chapter19.Sensitivity.Bounds.Results`
...
Checks all 57 public declarations the frozen B0003 route sends here.
-/
