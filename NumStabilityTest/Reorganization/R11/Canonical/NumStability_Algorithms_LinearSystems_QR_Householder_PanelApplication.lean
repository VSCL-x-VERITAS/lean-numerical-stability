...
/-!
# R11 canonical-only test — `PanelApplication`

Imports exactly the canonical destination `NumStability.Algorithms.LinearSystems.QR.Householder.PanelApplication`
...
Checks all 89 public declarations the frozen B0003 route sends here.
-/
