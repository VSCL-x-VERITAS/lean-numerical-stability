...
/-!
# R01 canonical-only import test C09

Imports exactly the frozen canonical leaf `NumStability.Algorithms.LinearSystems.Iterative.Stationary.Semiconvergence.BlockForm.Existence` and checks every public declaration routed there.
-/
