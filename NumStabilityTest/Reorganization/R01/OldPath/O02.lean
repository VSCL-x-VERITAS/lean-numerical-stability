...
/-!
# R01 historical-only import test O02

Imports exactly the historical owner `NumStability.Algorithms.StationaryIterationDrazin` and checks its complete preserved public surface.
-/
