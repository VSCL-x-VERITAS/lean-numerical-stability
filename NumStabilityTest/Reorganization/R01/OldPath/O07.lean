...
/-!
# R01 historical-only import test O07

Imports exactly the historical owner `NumStability.Analysis.SemiconvergentExistenceComplete` and checks its complete preserved public surface.
-/
