...
/-!
# R01 historical-only import test O06

Imports exactly the historical owner `NumStability.Analysis.SemiconvergentBlockFormExists` and checks its complete preserved public surface.
-/
