# B0007/R06 overlap review at exact C0003
...
Every R06 route is a whole-owner route: no owner splits across
...
`B0007-field-projection-scan.tsv` (Chapter27.SoftwareEnvironment lesson).

The concurrent wave R05 shares no owner, destination, edge, or
production consumer with R06; both waves' shared requests intersect only
