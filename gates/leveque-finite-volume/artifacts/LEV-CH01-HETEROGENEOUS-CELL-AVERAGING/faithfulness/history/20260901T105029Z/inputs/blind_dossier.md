...
∀ {Model : Type u_1} {Cell : Type u_2} {Point : Type u_3} {Parameter : Type u_4} {Property : Type u_5}
  ...
  (data : LocalDef003 Model Cell Point Parameter Property),
  And
            ...
            (And (Eq (cellRight Bool.false) 1)
              (And (Eq (cellLeft Bool.true) 1)
                (And (Eq (cellRight Bool.true) 2)
                  (And
                    (∀ (cell : Bool),
                      LocalDef002 (fun x => x) (cellLeft cell) (cellRight cell)
                        (assignedCellProperty cell))
                    (And
                      (∀ (field₁ field₂ : Real → Real) (cell : Bool),
                        Set.EqOn field₁ field₂ (Set.uIcc (cellLeft cell) (cellRight cell)) →
                          Eq (LocalDef011 field₁ (cellLeft cell) (cellRight cell))
                            (LocalDef011 field₂ (cellLeft cell) (cellRight cell)))
...
∀ {Model : Type u_1} {Cell : Type u_2} {Point : Type u_3} {Parameter : Type u_4} {Property : Type u_5}
  ...
  (data :
    @LocalDef003.{u_1, u_2, u_3, u_4, u_5} Model Cell Point Parameter Property
      inst),
  And
    (Iff
      ...
      (And
        (∀ (cell : Cell),
          @Ne.{1} ENNReal
            (@DFunLike.coe.{u_3 + 1, u_3 + 1, 1} (@MeasureTheory.Measure.{u_3} Point inst) (Set.{u_3} Point)
              ...
              (@LocalDef010.{u_1, u_2, u_3, u_4, u_5} Model Cell
                Point Parameter Property inst data)
              (@LocalDef005.{u_1, u_2, u_3, u_4, u_5} Model Cell
        ...
        (And
          (∀ (cell : Cell),
            And
              (@Eq.{u_5 + 1} Property
                (@LocalDef004.{u_1, u_2, u_3, u_4, u_5}
                ...
                (@LocalDef006.{u_1, u_2, u_3, u_4, u_5} Model
                  ...
                  (@LocalDef008.{u_1, u_2, u_3, u_4, u_5}
                    Model Cell Point Parameter Property inst data)
                  cell))
              (@LocalDef007.{u_1, u_2, u_3, u_4, u_5}
                Model Cell Point Parameter Property inst data
                (@LocalDef009.{u_1, u_2, u_3, u_4, u_5} Model Cell Point
                  Parameter Property inst data)
                (@LocalDef010.{u_1, u_2, u_3, u_4, u_5} Model
                  Cell Point Parameter Property inst data)
                (@LocalDef005.{u_1, u_2, u_3, u_4, u_5} Model Cell
                  Point Parameter Property inst data cell)
                (@LocalDef008.{u_1, u_2, u_3, u_4, u_5}
          ...
          (And
            (∀ (field₁ field₂ : Point → Parameter) (cell : Cell),
              (∀ (point : Point),
                ...
                @Eq.{u_5 + 1} Property
                  (@LocalDef006.{u_1, u_2, u_3, u_4, u_5}
                    ...
                    (And
                      (∀ (field₁ field₂ : Real → Real) (cell : Bool),
                        @Set.EqOn.{0, 0} Real Real field₁ field₂
                          ...
                          @Eq.{1} Real
                            (@LocalDef011.{0} Real Real.normedAddCommGroup
                              (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
                                (@NormedAddCommGroup.toSeminormedAddCommGroup.{0} Real Real.normedAddCommGroup)
                                (@RCLike.toInnerProductSpaceReal.{0} Real Real.instRCLike))
  ...
  {Cell : Type u_2} →
    {Point : Type u_3} →
      {Parameter : Type u_4} →
        {Property : Type u_5} →
          [inst : MeasurableSpace Point] →
            LocalDef003 Model Cell Point Parameter Property → Prop
```
...
fun {E} [NormedAddCommGroup E] [NormedSpace Real E] field left right average =>
  And (Real.instLT.lt left right)
    (And (IntervalIntegrable field Real.measureSpace.volume left right)
      (Eq average (LocalDef011 field left right)))
```
  ...
  {Cell : Type u_2} →
    {Point : Type u_3} →
      {Parameter : Type u_4} →
        {Property : Type u_5} →
          [inst : MeasurableSpace Point] →
            LocalDef003 Model Cell Point Parameter Property → Cell → Property
```
  ...
  {Cell : Type u_2} →
    {Point : Type u_3} →
      {Parameter : Type u_4} →
        {Property : Type u_5} →
          [inst : MeasurableSpace Point] →
            LocalDef003 Model Cell Point Parameter Property → Cell → Set Point
```
  ...
  {Cell : Type u_2} →
    {Point : Type u_3} →
      {Parameter : Type u_4} →
        {Property : Type u_5} →
          [inst : MeasurableSpace Point] →
            LocalDef003 Model Cell Point Parameter Property →
  ...
  {Cell : Type u_2} →
    {Point : Type u_3} →
      {Parameter : Type u_4} →
        {Property : Type u_5} →
          [inst : MeasurableSpace Point] →
            LocalDef003 Model Cell Point Parameter Property → Point → Parameter
```
  ...
  {Cell : Type u_2} →
    {Point : Type u_3} →
      {Parameter : Type u_4} →
        {Property : Type u_5} →
          [inst : MeasurableSpace Point] →
            LocalDef003 Model Cell Point Parameter Property → Model
```
