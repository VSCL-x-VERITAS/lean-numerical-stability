  ...
  (∀ (cell : Cell), Ne (MeasureTheory.Measure.instFunLike.coe volumeMeasure (grid.cellRegion cell)) 0) →
    (∀ (cell : Cell),
      ...
      (∀ (cell : Cell), MeasureTheory.IntegrableOn materialParameters (grid.cellRegion cell) volumeMeasure) →
        (Exists fun cell₁ =>
            Exists fun cell₂ =>
              Ne (NumStability.cellVolumeAverage volumeMeasure (grid.cellRegion cell₁) materialParameters)
            ...
            And
              (∀ (cell : Cell),
                NumStability.IsCellVolumeAverage volumeMeasure (grid.cellRegion cell) materialParameters
                  (assignedCellProperties cell).averagedParameter)
              (Exists fun cell₁ => Exists fun cell₂ => Ne (assignedCellProperties cell₁) (assignedCellProperties cell₂))
```
...
∀ {Cell : Type u_1} {Point : Type u_2} {Parameter : Type u_3} [inst : MeasurableSpace.{u_2} Point]
  ...
  (volumeMeasure : @MeasureTheory.Measure.{u_2} Point inst) (materialParameters : Point → Parameter)
  (hpositive :
    ∀ (cell : Cell),
      @Ne.{1} ENNReal
      ...
      @MeasureTheory.IntegrableOn.{u_2, u_3} Point Parameter inst
        ...
        (@SeminormedAddGroup.toContinuousENorm.{u_3} Parameter
          (@SeminormedAddCommGroup.toSeminormedAddGroup.{u_3} Parameter
            (@NormedAddCommGroup.toSeminormedAddCommGroup.{u_3} Parameter inst_1)))
        materialParameters (@NumStability.FiniteVolumeCellPartition.cellRegion.{u_1, u_2} Cell Point inst grid cell)
        volumeMeasure)
  (hdifferentCellAverages :
    @Exists.{u_1 + 1} Cell fun (cell₁ : Cell) =>
      @Exists.{u_1 + 1} Cell fun (cell₂ : Cell) =>
        @Ne.{u_3 + 1} Parameter
          (@NumStability.cellVolumeAverage.{u_2, u_3} Point Parameter inst inst_1 inst_2 volumeMeasure
            (@NumStability.FiniteVolumeCellPartition.cellRegion.{u_1, u_2} Cell Point inst grid cell₁)
            materialParameters)
          (@NumStability.cellVolumeAverage.{u_2, u_3} Point Parameter inst inst_1 inst_2 volumeMeasure
            (@NumStability.FiniteVolumeCellPartition.cellRegion.{u_1, u_2} Cell Point inst grid cell₂)
            materialParameters)),
  @Exists.{max (u_1 + 1) (u_3 + 1)} (Cell → NumStability.CellAveragedMaterialProperty.{u_3} Parameter)
    fun (assignedCellProperties : Cell → NumStability.CellAveragedMaterialProperty.{u_3} Parameter) =>
    And
      (∀ (cell : Cell),
        @NumStability.IsCellVolumeAverage.{u_2, u_3} Point Parameter inst inst_1 inst_2 volumeMeasure
          (@NumStability.FiniteVolumeCellPartition.cellRegion.{u_1, u_2} Cell Point inst grid cell) materialParameters
          (@NumStability.CellAveragedMaterialProperty.averagedParameter.{u_3} Parameter (assignedCellProperties cell)))
      (@Exists.{u_1 + 1} Cell fun (cell₁ : Cell) =>
        @Exists.{u_1 + 1} Cell fun (cell₂ : Cell) =>
          @Ne.{u_3 + 1} (NumStability.CellAveragedMaterialProperty.{u_3} Parameter) (assignedCellProperties cell₁)
            (assignedCellProperties cell₂))
```
...
### D003: `NumStability.FiniteVolumeCellPartition`
...
### D004: `NumStability.FiniteVolumeCellPartition.cellRegion`
...
### D005: `NumStability.IsCellVolumeAverage`
...
### D006: `NumStability.cellVolumeAverage`
...
### D008: `NumStability.FiniteVolumeCellPartition.mk`
...
### D014: `MeasureTheory.IntegrableOn`
...
### D068: `OmegaCompletePartialOrder.toPartialOrder`
...
### D069: `Order.Frame.toHeytingAlgebra`
...
### D070: `Set.instCompleteAtomicBooleanAlgebra`
...
SHA-256: `df0da6cbde29a24b5577a4ec0ec3927ca9091def8b46915c6bd1fc2fc84d8031`
