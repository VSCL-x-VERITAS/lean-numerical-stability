...
```lean
∀ {profile : Real → Real} {profile' : Real} (c x t : Real),
  Real.instLT.lt 0 c →
    Real.instLT.lt 0 t →
      HasDerivAt profile profile' (instHSub.hSub x (instHMul.hMul c t)) →
        And (LocalDef001 (LocalDef002 profile c) c x t)
          (And (Real.instLT.lt x (instHAdd.hAdd x (instHMul.hMul c t)))
            (Eq (LocalDef002 profile c (instHAdd.hAdd x (instHMul.hMul c t)) t) (profile x)))
```
...
∀ {profile : Real → Real} {profile' : Real} (c x t : Real)
  ...
  And (LocalDef001 (@LocalDef002.{0} Real profile c) c x t)
    (And
...
### D013: `IsTopologicalRing.toIsTopologicalSemiring`
...
### D014: `IsTopologicalSemiring.toContinuousMul`
...
### D016: `NonUnitalCommRing.toNonUnitalNonAssocCommRing`
...
### D017: `NonUnitalNonAssocCommRing.toNonUnitalNonAssocRing`
...
### D018: `NonUnitalNonAssocRing.toNonUnitalNonAssocSemiring`
...
### D019: `NonUnitalNormedCommRing.toNonUnitalCommRing`
...
### D022: `NontriviallyNormedField.toNormedField`
...
### D023: `NormedCommRing.toNonUnitalNormedCommRing`
...
### D025: `NormedField.toNormedCommRing`
...
### D049: `instIsTopologicalRingReal`
...
### D051: `AddCommGroup.toDivisionAddCommMonoid`
...
### D053: `AddCommMonoid.toAddCommSemigroup`
...
### D054: `AddCommSemigroup.toAddCommMagma`
...
### D060: `ENormedAddCommMonoid.toESeminormedAddCommMonoid`
...
### D061: `ESeminormedAddCommMonoid.toAddCommMonoid`
...
### D062: `ESeminormedAddCommMonoid.toESeminormedAddMonoid`
...
### D063: `ESeminormedAddMonoid.toAddMonoid`
...
### D085: `DivisionSemiring.toSemiring`
...
### D089: `Semifield.toDivisionSemiring`
...
### D090: `Semiring.toMonoidWithZero`
