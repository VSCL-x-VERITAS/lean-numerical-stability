...
SHA-256: `c33424174f3951f8f7fd3925e743399cddb1d92b79d84869693e33840f3a5940`
...
time derivative, space derivative, and zero-residual condition. The same
positive coefficient moves every translated profile to the right while
retaining its value. -/
theorem leveque01_equation04_positiveSpeedOneWayWave
    ...
    (leveque01_equation04_oneWayWaveAt w c x t ↔
      ...
      ∀ (profile : ℝ → ℝ) (y s : ℝ), 0 < s →
        y < y + c * s ∧
          travelingWave profile c (y + c * s) s = profile y := by
  constructor
  · exact Iff.rfl
  · intro profile y s hs
    exact leveque01_equation04_profileMovesRight profile c y s hc hs
