...
theorem leveque01_riemannInterfaceFlux_sourceContract
    {m : ℕ} {Information : Type*}
    (data : Leveque01RiemannInterfaceFluxData m Information) :
    IsLeveque01RiemannInterfaceFluxUpdate data ↔
      0 < data.fluxScale ∧
        (data.method.solverMode = .exact ∨
          data.method.solverMode = .approximate) ∧
        (∀ i,
          leveque01Equation11RiemannData
            (adjacentCellRiemannData data.cellAverages
              (data.valueAtOrigin i) i)
            (data.cellAverages (i - 1)) (data.cellAverages i)) ∧
        (∀ i,
          data.method.isSuitableSolverInformation data.method.solverMode
            (data.cellAverages (i - 1)) (data.cellAverages i)
            (data.method.solve
              (data.cellAverages (i - 1)) (data.cellAverages i))) ∧
        (∀ i,
          data.method.isPhysicalFluxApproximation
            (data.cellAverages (i - 1)) (data.cellAverages i)
        ...
        ∀ i,
          data.updatedCellAverages i =
            conservativeFluxDifferenceUpdateInt data.fluxScale
              data.cellAverages
              (fun j =>
                data.method.fluxFromInformation
                  (data.method.solve
                    (data.cellAverages (j - 1)) (data.cellAverages j))) i
```

## Elaborated target type

```lean
∀ {m : Nat} {Information : Type u_1} (data : NumStability.Leveque01RiemannInterfaceFluxData m Information),
  Iff (NumStability.IsLeveque01RiemannInterfaceFluxUpdate data)
    (And (Real.instLT.lt 0 data.fluxScale)
      (And
        (Or (Eq data.method.solverMode NumStability.RiemannSolverMode.exact)
          (Eq data.method.solverMode NumStability.RiemannSolverMode.approximate))
        (And
          (∀ (i : Int),
            NumStability.leveque01Equation11RiemannData
              (NumStability.adjacentCellRiemannData data.cellAverages (data.valueAtOrigin i) i)
            ...
            (And
              ...
              (∀ (i : Int),
                Eq (data.updatedCellAverages i)
                  (NumStability.conservativeFluxDifferenceUpdateInt data.fluxScale data.cellAverages
                    (fun j =>
                      data.method.fluxFromInformation
...
```lean
∀ {m : Nat} {Information : Type u_1} (data : NumStability.Leveque01RiemannInterfaceFluxData.{u_1} m Information),
  Iff (@NumStability.IsLeveque01RiemannInterfaceFluxUpdate.{u_1} m Information data)
    (And
      (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))
        (@NumStability.Leveque01RiemannInterfaceFluxData.fluxScale.{u_1} m Information data))
      (And
        (Or
          (@Eq.{1} NumStability.RiemannSolverMode
            (@NumStability.RiemannInterfaceFluxMethod.solverMode.{0, u_1, 0} (Fin m → Real) Information (Fin m → Real)
              (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data))
            NumStability.RiemannSolverMode.exact)
          (@Eq.{1} NumStability.RiemannSolverMode
            (@NumStability.RiemannInterfaceFluxMethod.solverMode.{0, u_1, 0} (Fin m → Real) Information (Fin m → Real)
              (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data))
            NumStability.RiemannSolverMode.approximate))
        (And
          (∀ (i : Int),
            @NumStability.leveque01Equation11RiemannData m
              (@NumStability.adjacentCellRiemannData.{0} (Fin m → Real)
                (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data)
                (@NumStability.Leveque01RiemannInterfaceFluxData.valueAtOrigin.{u_1} m Information data i) i)
              (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data
                (@HSub.hSub.{0, 0, 0} Int Int Int (@instHSub.{0} Int Int.instSub) i
                  (@OfNat.ofNat.{0} Int (nat_lit 1) (@instOfNat (nat_lit 1)))))
              (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data i))
          (And
            (∀ (i : Int),
              @NumStability.RiemannInterfaceFluxMethod.isSuitableSolverInformation.{0, u_1, 0} (Fin m → Real)
                Information (Fin m → Real)
                (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data)
                (@NumStability.RiemannInterfaceFluxMethod.solverMode.{0, u_1, 0} (Fin m → Real) Information
                  (Fin m → Real) (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data))
                (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data
                  (@HSub.hSub.{0, 0, 0} Int Int Int (@instHSub.{0} Int Int.instSub) i
                    (@OfNat.ofNat.{0} Int (nat_lit 1) (@instOfNat (nat_lit 1)))))
                (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data i)
                (@NumStability.RiemannInterfaceFluxMethod.solve.{0, u_1, 0} (Fin m → Real) Information (Fin m → Real)
                  (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data)
                  (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data
                    (@HSub.hSub.{0, 0, 0} Int Int Int (@instHSub.{0} Int Int.instSub) i
                      (@OfNat.ofNat.{0} Int (nat_lit 1) (@instOfNat (nat_lit 1)))))
            ...
            (And
              (∀ (i : Int),
                @NumStability.RiemannInterfaceFluxMethod.isPhysicalFluxApproximation.{0, u_1, 0} (Fin m → Real)
                  Information (Fin m → Real)
                  (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data)
                  (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data
                    (@HSub.hSub.{0, 0, 0} Int Int Int (@instHSub.{0} Int Int.instSub) i
                      (@OfNat.ofNat.{0} Int (nat_lit 1) (@instOfNat (nat_lit 1)))))
                  (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data i)
                  (@NumStability.RiemannInterfaceFluxMethod.fluxFromInformation.{0, u_1, 0} (Fin m → Real) Information
                    (Fin m → Real) (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data)
                    (@NumStability.RiemannInterfaceFluxMethod.solve.{0, u_1, 0} (Fin m → Real) Information
                      (Fin m → Real) (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data)
                      (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data
                        (@HSub.hSub.{0, 0, 0} Int Int Int (@instHSub.{0} Int Int.instSub) i
                          (@OfNat.ofNat.{0} Int (nat_lit 1) (@instOfNat (nat_lit 1)))))
              ...
              (∀ (i : Int),
                @Eq.{1} (Fin m → Real)
                  (@NumStability.Leveque01RiemannInterfaceFluxData.updatedCellAverages.{u_1} m Information data i)
                  (@NumStability.conservativeFluxDifferenceUpdateInt.{0} (Fin m → Real)
                    ...
                    (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data)
                    (fun (j : Int) =>
                      @NumStability.RiemannInterfaceFluxMethod.fluxFromInformation.{0, u_1, 0} (Fin m → Real)
                        Information (Fin m → Real)
                        (@NumStability.Leveque01RiemannInterfaceFluxData.method.{u_1} m Information data)
                        (@NumStability.RiemannInterfaceFluxMethod.solve.{0, u_1, 0} (Fin m → Real) Information
                          (Fin m → Real)
                          ...
                          (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data
                            (@HSub.hSub.{0, 0, 0} Int Int Int (@instHSub.{0} Int Int.instSub) j
                              (@OfNat.ofNat.{0} Int (nat_lit 1) (@instOfNat (nat_lit 1)))))
                          (@NumStability.Leveque01RiemannInterfaceFluxData.cellAverages.{u_1} m Information data j)))
                    i)))))))
```
...
### D001: `NumStability.IsLeveque01RiemannInterfaceFluxUpdate`
...
```lean
{m : Nat} → {Information : Type u_1} → NumStability.Leveque01RiemannInterfaceFluxData m Information → Prop
```
...
```lean
{m : Nat} →
  {Information : Type u_1} → (data : NumStability.Leveque01RiemannInterfaceFluxData.{u_1} m Information) → Prop
```
...
### D002: `NumStability.Leveque01RiemannInterfaceFluxData`
...
```lean
(m : Nat) → (Information : Type u_1) → Type u_1
```

### D003: `NumStability.Leveque01RiemannInterfaceFluxData.cellAverages`
...
```lean
{m : Nat} → {Information : Type u_1} → NumStability.Leveque01RiemannInterfaceFluxData m Information → Int → Fin m → Real
```
...
{m : Nat} →
  {Information : Type u_1} →
    (self : NumStability.Leveque01RiemannInterfaceFluxData.{u_1} m Information) → Int → Fin m → Real
```
...
### D004: `NumStability.Leveque01RiemannInterfaceFluxData.fluxScale`
...
```lean
{m : Nat} → {Information : Type u_1} → NumStability.Leveque01RiemannInterfaceFluxData m Information → Real
```
...
```lean
{m : Nat} →
  {Information : Type u_1} → (self : NumStability.Leveque01RiemannInterfaceFluxData.{u_1} m Information) → Real
```
...
### D005: `NumStability.Leveque01RiemannInterfaceFluxData.method`
...
{m : Nat} →
  {Information : Type u_1} →
    NumStability.Leveque01RiemannInterfaceFluxData m Information →
      NumStability.RiemannInterfaceFluxMethod (Fin m → Real) Information (Fin m → Real)
```
...
{m : Nat} →
  {Information : Type u_1} →
    (self : NumStability.Leveque01RiemannInterfaceFluxData.{u_1} m Information) →
      NumStability.RiemannInterfaceFluxMethod.{0, u_1, 0} (Fin m → Real) Information (Fin m → Real)
```
...
### D006: `NumStability.Leveque01RiemannInterfaceFluxData.updatedCellAverages`
...
### D007: `NumStability.Leveque01RiemannInterfaceFluxData.valueAtOrigin`
...
### D008: `NumStability.RiemannInterfaceFluxMethod.fluxFromInformation`
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} → NumStability.RiemannInterfaceFluxMethod State Information Flux → Information → Flux
```
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} →
      (self : NumStability.RiemannInterfaceFluxMethod.{u_1, u_2, u_3} State Information Flux) → Information → Flux
```
...
### D009: `NumStability.RiemannInterfaceFluxMethod.isPhysicalFluxApproximation`
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} → NumStability.RiemannInterfaceFluxMethod State Information Flux → State → State → Flux → Prop
```
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} →
      (self : NumStability.RiemannInterfaceFluxMethod.{u_1, u_2, u_3} State Information Flux) →
        State → State → Flux → Prop
```
...
### D010: `NumStability.RiemannInterfaceFluxMethod.isSuitableSolverInformation`
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} →
      NumStability.RiemannInterfaceFluxMethod State Information Flux →
        NumStability.RiemannSolverMode → State → State → Information → Prop
```
...
### D011: `NumStability.RiemannInterfaceFluxMethod.solve`
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} → NumStability.RiemannInterfaceFluxMethod State Information Flux → State → State → Information
```
...
### D012: `NumStability.RiemannInterfaceFluxMethod.solverMode`
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} → NumStability.RiemannInterfaceFluxMethod State Information Flux → NumStability.RiemannSolverMode
```
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} →
      (self : NumStability.RiemannInterfaceFluxMethod.{u_1, u_2, u_3} State Information Flux) →
        NumStability.RiemannSolverMode
```
...
### D013: `NumStability.RiemannSolverMode`
...
### D014: `NumStability.RiemannSolverMode.approximate`
...
### D015: `NumStability.RiemannSolverMode.exact`
...
### D016: `NumStability.adjacentCellRiemannData`
...
### D017: `NumStability.conservativeFluxDifferenceUpdateInt`
...
### D018: `NumStability.leveque01Equation11RiemannData`
...
### D019: `NumStability.IsRiemannData`
...
### D020: `NumStability.Leveque01RiemannInterfaceFluxData.mk`
...
{m : Nat} →
  {Information : Type u_1} →
    (Int → Fin m → Real) →
      (Int → Fin m → Real) →
        NumStability.RiemannInterfaceFluxMethod (Fin m → Real) Information (Fin m → Real) →
          Real → (Int → Fin m → Real) → NumStability.Leveque01RiemannInterfaceFluxData m Information
```
...
{m : Nat} →
  {Information : Type u_1} →
    (cellAverages valueAtOrigin : Int → Fin m → Real) →
      (method : NumStability.RiemannInterfaceFluxMethod.{0, u_1, 0} (Fin m → Real) Information (Fin m → Real)) →
        (fluxScale : Real) →
          (updatedCellAverages : Int → Fin m → Real) →
            NumStability.Leveque01RiemannInterfaceFluxData.{u_1} m Information
```

### D021: `NumStability.RiemannInterfaceFluxMethod`
...
```lean
(State : Type u_1) → (Information : Type u_2) → (Flux : Type u_3) → Type (max (max u_1 u_2) u_3)
```

### D022: `NumStability.riemannData`
...
### D023: `NumStability.RiemannInterfaceFluxMethod.mk`
    ...
    {Flux : Type u_3} →
      NumStability.RiemannSolverMode →
        (State → State → Information) →
          (Information → Flux) →
            (NumStability.RiemannSolverMode → State → State → Information → Prop) →
              (State → State → Flux → Prop) → NumStability.RiemannInterfaceFluxMethod State Information Flux
```
...
{State : Type u_1} →
  {Information : Type u_2} →
    {Flux : Type u_3} →
      (solverMode : NumStability.RiemannSolverMode) →
        (solve : State → State → Information) →
          (fluxFromInformation : Information → Flux) →
            (isSuitableSolverInformation : NumStability.RiemannSolverMode → State → State → Information → Prop) →
              (isPhysicalFluxApproximation : State → State → Flux → Prop) →
                NumStability.RiemannInterfaceFluxMethod.{u_1, u_2, u_3} State Information Flux
```
