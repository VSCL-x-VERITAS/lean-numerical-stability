# Declaration dossier for LEV-CH01-ADVECTION-LINEAR-FLUX
...
∀ (q : Real → Real → Real) (speed x t : Real),
  NumStability.leveque01_equation02_scalarAdvectionAt q speed x t →
    And
      (NumStability.leveque01_equation08_conservationLawAt (NumStability.scalarAsOneComponentSystem q)
        (NumStability.constantLinearFlux (NumStability.constantCoefficientScalarMatrix speed)) x t)
      (∀ (state : Fin 1 → Real),
        Eq (NumStability.constantLinearFlux (NumStability.constantCoefficientScalarMatrix speed) state) fun x =>
          instHMul.hMul speed (state 0))
```
...
```lean
∀ (q : Real → Real → Real) (speed x t : Real)
  (hadvection : NumStability.leveque01_equation02_scalarAdvectionAt q speed x t),
  And
    (@NumStability.leveque01_equation08_conservationLawAt (@OfNat.ofNat.{0} Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))
...
- `AuditTarget` imports: `NumStability.Source.LeVeque.Chapter01.Equation02`, `NumStability.Source.LeVeque.Chapter01.LinearFluxSpecialization`
...
- `NumStability.Source.LeVeque.Chapter01.LinearFluxSpecialization` imports: `NumStability.Source.LeVeque.Chapter01.Equation01`, `NumStability.Source.LeVeque.Chapter01.Equation08`
...
### D002: `NumStability.constantLinearFlux`
...
- Role: `local`
- Owner module: `NumStability.Source.LeVeque.Chapter01.Equation02`
- Declaration kind: `abbrev`
- Distance from target type: `1`
- Semantic SHA-256: `a6204ca63a7e4736baaea31b452d7a47f68e23d65ba6a2709754883ae769d1f5`
...
### D004: `NumStability.leveque01_equation08_conservationLawAt`
...
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `56e414d37f321fbc3fa3dec2b3483e57f5344645a029a681691c1e57eb4144de`
...
### D029: `NonUnitalNormedCommRing.toNonUnitalCommRing`
...
### D030: `NormedCommRing.toNonUnitalNormedCommRing`
...
### D035: `AddCommGroup.toDivisionAddCommMonoid`
...
### D037: `AddCommMonoid.toAddCommSemigroup`
...
### D038: `AddCommSemigroup.toAddCommMagma`
...
### D042: `DenselyNormedField.toNontriviallyNormedField`
...
### D045: `DivisionSemiring.toSemiring`
...
### D046: `ENormedAddCommMonoid.toESeminormedAddCommMonoid`
...
### D047: `ESeminormedAddCommMonoid.toAddCommMonoid`
...
### D048: `ESeminormedAddCommMonoid.toESeminormedAddMonoid`
...
### D049: `ESeminormedAddMonoid.toAddMonoid`
...
### D055: `Module.toDistribMulAction`
...
### D057: `NonUnitalNonAssocSemiring.toAddCommMonoid`
...
### D060: `NonUnitalSemiring.toNonUnitalNonAssocSemiring`
...
### D061: `NontriviallyNormedField.toNormedField`
...
### D063: `NormedAddCommGroup.toAddCommGroup`
...
### D064: `NormedAddCommGroup.toENormedAddCommMonoid`
...
### D086: `Semifield.toDivisionSemiring`
...
### D087: `SeminormedAddCommGroup.toPseudoMetricSpace`
...
### D089: `Semiring.toNonUnitalSemiring`
...
### D093: `UniformSpace.toTopologicalSpace`
...
### D099: `AddCommMonoid.toAddMonoid`
...
### D102: `DistribMulAction.toMulAction`
...
### D105: `MulAction.toSemigroupAction`
...
### D106: `NormedField.toNormedCommRing`
...
### D109: `SeminormedCommRing.toSeminormedRing`
...
### D110: `SeminormedRing.toPseudoMetricSpace`
...
### D111: `Semiring.toMonoidWithZero`
...
### `NumStability.Source.LeVeque.Chapter01.LinearFluxSpecialization`

Path: `NumStability/Source/LeVeque/Chapter01/LinearFluxSpecialization.lean`
SHA-256: `c3da5f0957e45af840d4c9e224e7eadb6c7c9409cad97ba652939843a28f0df2`
