# Declaration dossier for LEV-CH01-EQ-1.3-ADVECTED-PROFILE
...
```lean
∀ {profile : Real → Real} {profile' speed x t : Real},
  HasDerivAt profile profile' (instHSub.hSub x (instHMul.hMul speed t)) →
    NumStability.IsLinearAdvectionSolutionAt (NumStability.travelingWave profile speed) speed x t
```
...
∀ {profile : Real → Real} {profile' speed x t : Real}
  ...
  @NumStability.IsLinearAdvectionSolutionAt.{0} Real Real.normedAddCommGroup
    (@NormedField.toNormedSpace.{0} Real Real.normedField) (@NumStability.travelingWave.{1} Real profile speed) speed x
    t
```
...
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `591a0d1a0637b9d26468142f5da238f53a01fdbc8a82e5de03b8681476bce450`

Type:

```lean
{E : Sort u_1} → (Real → E) → Real → Real → Real → E
```

Fully explicit type:

```lean
{E : Sort u_1} → (profile : Real → E) → (speed x t : Real) → E
```
...
### D003: `NumStability.IsLinearAdvectionSolutionAt._proof_1`
...
### D004: `ContinuousMul.to_continuousSMul`
...
### D005: `DenselyNormedField.toNontriviallyNormedField`
...
### D009: `IsTopologicalRing.toIsTopologicalSemiring`
...
### D010: `IsTopologicalSemiring.toContinuousMul`
...
### D011: `NonUnitalCommRing.toNonUnitalNonAssocCommRing`
...
### D012: `NonUnitalNonAssocCommRing.toNonUnitalNonAssocRing`
...
### D013: `NonUnitalNonAssocRing.toNonUnitalNonAssocSemiring`
...
### D014: `NonUnitalNormedCommRing.toNonUnitalCommRing`
...
### D015: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D016: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D017: `NontriviallyNormedField.toNormedField`
...
### D018: `NormedCommRing.toNonUnitalNormedCommRing`
...
### D019: `NormedCommRing.toSeminormedCommRing`
...
### D020: `NormedField.toNormedCommRing`
...
### D021: `NormedField.toNormedSpace`
...
### D033: `SeminormedCommRing.toNonUnitalSeminormedCommRing`
...
### D034: `SeminormedCommRing.toSeminormedRing`
...
### D035: `SeminormedRing.toPseudoMetricSpace`
...
### D039: `instIsTopologicalRingReal`
...
### D040: `AddCommGroup.toDivisionAddCommMonoid`
...
### D042: `AddCommMonoid.toAddCommSemigroup`
...
### D043: `AddCommSemigroup.toAddCommMagma`
...
### D050: `ENormedAddCommMonoid.toESeminormedAddCommMonoid`
...
### D051: `ESeminormedAddCommMonoid.toAddCommMonoid`
...
### D052: `ESeminormedAddCommMonoid.toESeminormedAddMonoid`
...
### D053: `ESeminormedAddMonoid.toAddMonoid`
...
### D058: `Module.toDistribMulAction`
...
### D061: `NormedAddCommGroup.toAddCommGroup`
...
### D062: `NormedAddCommGroup.toENormedAddCommMonoid`
...
### D069: `SeminormedAddCommGroup.toPseudoMetricSpace`
...
### D070: `SubNegZeroMonoid.toNegZeroClass`
...
### D071: `SubtractionCommMonoid.toSubtractionMonoid`
...
### D072: `SubtractionMonoid.toSubNegZeroMonoid`
...
### D084: `Semifield.toDivisionSemiring`
