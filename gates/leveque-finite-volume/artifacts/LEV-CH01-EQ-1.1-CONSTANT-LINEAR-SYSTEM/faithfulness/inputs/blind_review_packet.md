...
∀ {m : Nat} {coefficient : Matrix (Fin m) (Fin m) Real}
  (system : LocalDef001 coefficient) (x t : Real),
  Exists fun qt =>
    Exists fun qx =>
...
∀ {m : Nat} {coefficient : Matrix.{0, 0, 0} (Fin m) (Fin m) Real}
  (system : @LocalDef001.{0} (Fin m) (Fin.fintype m) coefficient) (x t : Real),
    ...
    @Exists.{1} (Fin m → Real) fun (qx : Fin m → Real) =>
      And
        (@HasDerivAt.{0, 0} Real (@DenselyNormedField.toNontriviallyNormedField.{0} Real Real.denselyNormedField)
          ...
          (fun (τ : Real) =>
            @LocalDef002.{0} (Fin m) (Fin.fintype m) coefficient system x
              τ)
          qt t)
        (And
          (@HasDerivAt.{0, 0} Real (@DenselyNormedField.toNontriviallyNormedField.{0} Real Real.denselyNormedField)
              ...
              @ContinuousMul.to_continuousSMul.{0} Real
                ...
                (@IsTopologicalSemiring.toContinuousMul.{0} Real
                  ...
                  (@IsTopologicalRing.toIsTopologicalSemiring.{0} Real
                    ...
                    instIsTopologicalRingReal)))
            (fun (ξ : Real) =>
              @LocalDef002.{0} (Fin m) (Fin.fintype m) coefficient system
                ξ t)
            qx x)
          (@Eq.{1} (Fin m → Real)
...
{ι : Type u_1} →
  [inst : Fintype ι] →
    {coefficient : Matrix ι ι Real} →
      LocalDef001 coefficient → Real → Real → ι → Real
```
  ...
  [inst : Fintype ι] →
    {coefficient : Matrix ι ι Real} →
      (state : Real → Real → ι → Real) →
        (∀ (x t : Real), LocalDef004 state coefficient x t) →
