...
/-!
# Coupled Horner derivative recurrences

Reusable coupled backward- and forward-error bounds for the rounded Horner
value/derivative recurrence. Private algebraic helpers remain atomic with the
public recurrence theorems that consume them.
-/
