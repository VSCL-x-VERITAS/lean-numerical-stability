...
/-!
# Fast polynomial-evaluation quintic kernel

Reusable existence results for the nine-operation monic quintic kernel and
the induced fast evaluation scheme. Private polynomial and fold helpers remain
atomic with the public theorems.
-/
