...
/-!
# Bidiagonal derivative inverse and rounded solve

Reusable inverse identities, exact solve results, and rounded one- and
two-sweep error bounds for the bidiagonal derivative-evaluation system.
Private row and floating-point helpers remain atomic with their consumers.
-/
