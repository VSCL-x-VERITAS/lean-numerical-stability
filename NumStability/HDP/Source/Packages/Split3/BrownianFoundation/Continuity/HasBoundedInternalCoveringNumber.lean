...
-/
import NumStability.HDP.Source.Packages.Split3.BrownianFoundation.Continuity.CoveringNumber
...
lemma isCoverWithBoundedCoveringNumber_Ico_nnreal :
  ...
  totallyBounded n := by
    ...
    apply (totallyBounded_image_iff h_iso.isUniformInducing).mp
    convert totallyBounded_Ico (0 : ℝ) (n + 1) using 1
    ext x
