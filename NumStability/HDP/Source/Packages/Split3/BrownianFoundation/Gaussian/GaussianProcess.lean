...
lemma iIndepFun_of_covariance_eq_zero {X : (t : T) → (s : S t) → Ω → ℝ}
  ...
  hX.iIndepFun_of_covariance_inner mX fun _ _ h' _ _ _ _ ↦ by
    simp [real_inner_eq_mul, covariance_const_mul_left, covariance_const_mul_right, h _ _ h']
...
lemma indepFun_of_covariance_eq_zero {X : S → Ω → ℝ} {Y : T → Ω → ℝ}
  ...
  hXY.indepFun_of_covariance_inner mX mY fun _ _ _ _ ↦ by
    simp [real_inner_eq_mul, covariance_const_mul_left, covariance_const_mul_right, h]
...
lemma IsGaussianProcess.indepFun'' {X : S → Ω → ℝ} {Y : T → Ω → ℝ}
  ...
  h.indepFun_of_covariance_inner hX hY fun _ _ _ _ ↦ by
    simp [IsGaussianProcess.real_inner_eq_mul, covariance_const_mul_left,
      covariance_const_mul_right, h']
...
lemma IsGaussianProcess.iIndepFun'' {S : T → Type*}
  ...
  h.iIndepFun_of_covariance_inner hX fun _ _ h'' _ _ _ _ ↦ by
    simp [IsGaussianProcess.real_inner_eq_mul, covariance_const_mul_left,
      covariance_const_mul_right, h' _ _ h'']
