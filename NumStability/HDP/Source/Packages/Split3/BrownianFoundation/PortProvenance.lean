...
This tree is a selective source port used to prove the local
...
`NumStability.HDP.Source.Packages.Split3.BrownianFoundation`; theorem bodies
and namespaces were otherwise preserved before pinned-baseline compatibility
repairs.
-/
