...
import NumStability.Source.Higham.Chapter14.Theorem05.ForwardError.PrintedEnvelopeBounds

/-!
# Higham Theorem 14.5: source endpoints

Historical path, retained so existing imports of `NumStability.Algorithms.Ch14GJETheorem145SourceClosure`
