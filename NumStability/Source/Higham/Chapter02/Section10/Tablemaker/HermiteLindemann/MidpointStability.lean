...
/-!
# Chapter02 Section10 Tablemaker HermiteLindemann MidpointStability

Canonical source owner for the exponential midpoint-separation and eventual
comparison-stability closure used by Higham's tablemaker discussion.
-/
