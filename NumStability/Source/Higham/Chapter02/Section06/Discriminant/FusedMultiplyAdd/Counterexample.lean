...
/-!
# Chapter02 Section06 Discriminant FusedMultiplyAdd Counterexample

Canonical source owner for the IEEE-single fused-multiply-add discriminant
counterexample and its complete private-helper closure.
-/
