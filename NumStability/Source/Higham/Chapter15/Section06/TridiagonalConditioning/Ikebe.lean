-- Historical owner: Algorithms/LU/TridiagonalCondCh15IkebeClosure.lean
--
...
/-!
# Higham Theorem 15.9 Ikebe closure

The inverse rank-one triangle structure from the printed irreducible
tridiagonal and right-inverse hypotheses.
-/
