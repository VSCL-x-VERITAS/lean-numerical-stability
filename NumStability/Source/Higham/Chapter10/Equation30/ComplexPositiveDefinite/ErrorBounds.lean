...
/-!
# Higham equation (10.30) error bounds

Positive-definite symmetric-part growth estimates, complex LU structure, and
the resulting source-facing backward-error bounds.
-/
