...
/-!
# Higham Theorem 10.14 stopping and error bounds

The actual complete-pivoting stopping test controls the exact PSD Schur
residual and its componentwise and operator-norm backward errors.
-/
