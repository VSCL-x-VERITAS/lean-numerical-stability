...
/-!
# Higham Theorem 10.14 rank-sensitive error

Rank-sensitive operator-norm bounds for equations (10.24)--(10.25), together
with the source success-and-error endpoint.
-/
