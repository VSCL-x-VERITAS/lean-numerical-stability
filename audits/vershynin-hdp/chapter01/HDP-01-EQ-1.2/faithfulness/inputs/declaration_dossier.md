# Declaration dossier for HDP-01-EQ-1.2
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] (μ : MeasureTheory.Measure Ω) [MeasureTheory.IsProbabilityMeasure μ]
  ...
  MeasureTheory.MemLp X 2 μ →
    MeasureTheory.MemLp Y 2 μ →
      And
        (Eq (NumStability.HDP.Scalar.Preliminaries.covariance μ X Y)
        ...
        (Eq
          (NumStability.HDP.Scalar.Preliminaries.expectation μ fun ω =>
            instHMul.hMul (instHSub.hSub (X ω) (NumStability.HDP.Scalar.Preliminaries.expectation μ X))
              (instHSub.hSub (Y ω) (NumStability.HDP.Scalar.Preliminaries.expectation μ Y)))
          (NumStability.HDP.Scalar.Preliminaries.l2InnerProduct μ
            (fun ω => instHSub.hSub (X ω) (NumStability.HDP.Scalar.Preliminaries.expectation μ X)) fun ω =>
            instHSub.hSub (Y ω) (NumStability.HDP.Scalar.Preliminaries.expectation μ Y)))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] (μ : @MeasureTheory.Measure.{u_1} Ω inst)
  ...
  (_hY :
    @MeasureTheory.MemLp.{u_1, 0} Ω Real inst
      ...
      μ),
  And
    (@Eq.{1} Real (@NumStability.HDP.Scalar.Preliminaries.covariance.{u_1} Ω inst μ X Y)
      (@NumStability.HDP.Scalar.Preliminaries.expectation.{u_1} Ω inst μ fun (ω : Ω) =>
        @HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
          ...
          (@HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub) (Y ω)
            (@NumStability.HDP.Scalar.Preliminaries.expectation.{u_1} Ω inst μ Y))))
    (@Eq.{1} Real
      (@NumStability.HDP.Scalar.Preliminaries.expectation.{u_1} Ω inst μ fun (ω : Ω) =>
        @HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
          (@HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub) (X ω)
          ...
          (@HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub) (Y ω)
            (@NumStability.HDP.Scalar.Preliminaries.expectation.{u_1} Ω inst μ Y)))
      (@NumStability.HDP.Scalar.Preliminaries.l2InnerProduct.{u_1} Ω inst μ
        (fun (ω : Ω) =>
          @HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub) (X ω)
            (@NumStability.HDP.Scalar.Preliminaries.expectation.{u_1} Ω inst μ X))
        fun (ω : Ω) =>
...
- Semantic SHA-256: `2598294b42e4d990e911334443c5c1cdcde80fbe626ea926fc10a0f4ec0145e2`
...
### D003: `NumStability.HDP.Scalar.Preliminaries.l2InnerProduct`
...
### D039: `InnerProductSpace.toNormedSpace`
...
### D042: `RCLike.toInnerProductSpaceReal`
