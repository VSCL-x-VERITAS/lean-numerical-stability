...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] (μ : MeasureTheory.Measure Ω) [MeasureTheory.IsProbabilityMeasure μ]
  ...
  MeasureTheory.MemLp X 2 μ →
    MeasureTheory.MemLp Y 2 μ →
      And
        (Eq (LocalDef001 μ X Y)
          (LocalDef002 μ fun ω =>
            instHMul.hMul (instHSub.hSub (X ω) (LocalDef002 μ X))
              (instHSub.hSub (Y ω) (LocalDef002 μ Y))))
        (Eq
          (LocalDef002 μ fun ω =>
            instHMul.hMul (instHSub.hSub (X ω) (LocalDef002 μ X))
              (instHSub.hSub (Y ω) (LocalDef002 μ Y)))
          (LocalDef003 μ
            (fun ω => instHSub.hSub (X ω) (LocalDef002 μ X)) fun ω =>
            instHSub.hSub (Y ω) (LocalDef002 μ Y)))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] (μ : @MeasureTheory.Measure.{u_1} Ω inst)
  ...
  (_hY :
    @MeasureTheory.MemLp.{u_1, 0} Ω Real inst
      ...
      μ),
  And
    (@Eq.{1} Real (@LocalDef001.{u_1} Ω inst μ X Y)
...
```lean
fun {Ω} [MeasurableSpace Ω] μ X Y =>
  LocalDef002 μ fun ω => instHMul.hMul (X ω) (Y ω)
```
