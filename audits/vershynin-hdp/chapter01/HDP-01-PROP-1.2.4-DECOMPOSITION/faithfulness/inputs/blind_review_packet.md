...
```lean
∀ (x t : Real),
  Eq x (instHAdd.hAdd (instHMul.hMul x (ite (Real.instLE.le t x) 1 0)) (instHMul.hMul x (ite (Real.instLT.lt x t) 1 0)))
```
  ...
  @Eq.{1} Real x
    (@HAdd.hAdd.{0, 0, 0} Real Real Real (@instHAdd.{0} Real Real.instAdd)
      (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) x
        (@ite.{1} Real (@LE.le.{0} Real Real.instLE t x) (Real.decidableLE t x)
          (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne))
          (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))))
      (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) x
        (@ite.{1} Real (@LT.lt.{0} Real Real.instLT x t) (Real.decidableLT x t)
          (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne))
          (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)))))
```
