# Declaration dossier for HDP-01-EXERCISE-1.2.2-CORRECTED
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  Measurable X →
    MeasureTheory.Integrable X μ →
      Eq (MeasureTheory.integral μ fun ω => X ω)
        (instHSub.hSub
          (MeasureTheory.integral (Real.measureSpace.volume.restrict (Set.Ioi 0)) fun t =>
            μ.real (setOf fun a => Real.instLT.lt t (X a)))
          (MeasureTheory.integral (Real.measureSpace.volume.restrict (Set.Iio 0)) fun t =>
            μ.real (setOf fun a => Real.instLT.lt (X a) t)))
```
  ...
  @Eq.{1} Real
    ...
    (@HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub)
      (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
        ...
        fun (t : Real) =>
        @MeasureTheory.Measure.real.{u_1} Ω inst μ (@setOf.{u_1} Ω fun (a : Ω) => @LT.lt.{0} Real Real.instLT t (X a)))
      (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
        (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
          (@NormedAddCommGroup.toSeminormedAddCommGroup.{0} Real Real.normedAddCommGroup)
          (@RCLike.toInnerProductSpaceReal.{0} Real Real.instRCLike))
        ...
        (@MeasureTheory.Measure.restrict.{0} Real
          ...
          (@Set.Iio.{0} Real Real.instPreorder
            (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))))
        fun (t : Real) =>
        @MeasureTheory.Measure.real.{u_1} Ω inst μ (@setOf.{u_1} Ω fun (a : Ω) => @LT.lt.{0} Real Real.instLT (X a) t)))
```
...
### D003: `InnerProductSpace.toNormedSpace`
...
### D011: `MeasureTheory.Measure.restrict`
