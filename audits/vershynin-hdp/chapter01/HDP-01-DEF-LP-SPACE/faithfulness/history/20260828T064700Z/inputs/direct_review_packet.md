...
theorem hdp_01_hdef_hlp_hspace_spec
    ...
    ((NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel μ p).representativeMember X ↔
        eLpNorm X p μ < ⊤) ∧
      (NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel μ p).quotient =
    ...
    ∀ (X : Ω → Real),
      MeasureTheory.AEStronglyMeasurable X μ →
        And
          ...
          (Eq (NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel μ p).quotient (MeasureTheory.Lp Real p μ))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] (μ : @MeasureTheory.Measure.{u_1} Ω inst)
  ...
  And
    ...
    (@Eq.{u_1 + 1}
      ...
      (@NumStability.HDP.Scalar.Preliminaries.LpNormSpaceModelData.quotient.{u_1} Ω inst μ p
        (@NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel.{u_1} Ω inst μ p))
...
### D001: `NumStability.HDP.Scalar.Preliminaries.LpNormSpaceModelData.quotient`
...
{Ω : Type u_1} →
  [inst : MeasurableSpace Ω] →
    {μ : MeasureTheory.Measure Ω} →
      {p : ENNReal} →
        NumStability.HDP.Scalar.Preliminaries.LpNormSpaceModelData μ p → AddSubgroup (MeasureTheory.AEEqFun Ω Real μ)
```
...
{Ω : Type u_1} →
  [inst : MeasurableSpace.{u_1} Ω] →
    {μ : @MeasureTheory.Measure.{u_1} Ω inst} →
      {p : ENNReal} →
        (self : @NumStability.HDP.Scalar.Preliminaries.LpNormSpaceModelData.{u_1} Ω inst μ p) →
          @AddSubgroup.{u_1}
            (@MeasureTheory.AEEqFun.{u_1, 0} Ω Real inst
              (@UniformSpace.toTopologicalSpace.{0} Real
                (@PseudoMetricSpace.toUniformSpace.{0} Real Real.pseudoMetricSpace))
...
### D002: `NumStability.HDP.Scalar.Preliminaries.LpNormSpaceModelData.representativeMember`
...
### D003: `NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel`
...
### D004: `NumStability.HDP.Scalar.Preliminaries.LpNormSpaceModelData`
...
### D005: `NumStability.HDP.Scalar.Preliminaries.LpNormSpaceModelData.mk`
...
### D006: `NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel._proof_1`
...
### D007: `NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel._proof_2`
...
### D008: `NumStability.HDP.Scalar.Preliminaries.lpNormSpaceModel._proof_3`
