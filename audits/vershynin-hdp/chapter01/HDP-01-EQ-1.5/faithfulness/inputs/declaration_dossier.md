# Declaration dossier for HDP-01-EQ-1.5
...
```lean
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsFiniteMeasure μ] (N : Nat)
  (hN : instLTNat.lt 0 N) {X : Fin N → Ω → Real},
  (∀ (i : Fin N), MeasureTheory.MemLp (X i) 2 μ) →
    (∀ ⦃i j : Fin N⦄, Ne i j → ProbabilityTheory.IndepFun (X i) (X j) μ) →
      (∀ (i : Fin N), ProbabilityTheory.IdentDistrib (X i) (X ⟨0, hN⟩) μ μ) →
        Eq
          (ProbabilityTheory.variance
            (fun ω => instHMul.hMul (Real.instInv.inv N.cast) (Finset.univ.sum fun i => X i ω)) μ)
          (instHMul.hMul (Real.instInv.inv N.cast) (ProbabilityTheory.variance (X ⟨0, hN⟩) μ))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  [@MeasureTheory.IsFiniteMeasure.{u_1} Ω inst μ] (N : Nat)
  (hN : @LT.lt.{0} Nat instLTNat (@OfNat.ofNat.{0} Nat (nat_lit 0) (instOfNatNat (nat_lit 0))) N) {X : Fin N → Ω → Real}
  (hX :
    ∀ (i : Fin N),
  ...
  (hIndep :
    ∀ ⦃i j : Fin N⦄,
      @Ne.{1} (Fin N) i j →
        @ProbabilityTheory.IndepFun.{u_1, 0, 0} Ω Real Real inst Real.measurableSpace Real.measurableSpace (X i) (X j)
          μ)
  (hIdent :
    ∀ (i : Fin N),
      @ProbabilityTheory.IdentDistrib.{u_1, u_1, 0} Ω Ω Real inst inst Real.measurableSpace (X i)
        (X (@Fin.mk N (@OfNat.ofNat.{0} Nat (nat_lit 0) (instOfNatNat (nat_lit 0))) hN)) μ μ),
  @Eq.{1} Real
    ...
    (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
      (@Inv.inv.{0} Real Real.instInv (@Nat.cast.{0} Real Real.instNatCast N))
      (@ProbabilityTheory.variance.{u_1} Ω inst
        (X (@Fin.mk N (@OfNat.ofNat.{0} Nat (nat_lit 0) (instOfNatNat (nat_lit 0))) hN)) μ))
```
...
### D015: `MeasureTheory.IsFiniteMeasure`
...
### D027: `ProbabilityTheory.IdentDistrib`
...
### D028: `ProbabilityTheory.IndepFun`
...
### D029: `ProbabilityTheory.variance`
...
### D041: `SeminormedAddGroup.toPseudoMetricSpace`
...
### D044: `instAddCommMonoidWithOneENNReal`
