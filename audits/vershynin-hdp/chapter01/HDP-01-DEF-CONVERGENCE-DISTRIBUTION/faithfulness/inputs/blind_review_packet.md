      ...
      Filter.Tendsto
        (fun N =>
          MeasureTheory.ProbabilityMeasure.instFunLike.coe
            (LocalDef005
              (LocalDef003 X m σ (instHAdd.hAdd N 1)) ⋯)
            (Set.Iic t))
        Filter.atTop
        (nhds
          (MeasureTheory.ProbabilityMeasure.instFunLike.coe
            LocalDef002 (Set.Iic t))))
```
      ...
      @Filter.Tendsto.{0, 0} Nat NNReal
        (fun (N : Nat) =>
          @DFunLike.coe.{1, 1, 1} (@MeasureTheory.ProbabilityMeasure.{0} Real Real.measurableSpace) (Set.{0} Real)
            ...
            (@LocalDef005.{u_1} Ω inst μ inst_1
              (@LocalDef003.{u_1} Ω X m σ
                (@HAdd.hAdd.{0, 0, 0} Nat Nat Nat (@instHAdd.{0} Nat instAddNat) N
                  (@OfNat.ofNat.{0} Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))))
              (@LocalDef004.{u_1} Ω inst μ X m σ
                (@HAdd.hAdd.{0, 0, 0} Nat Nat Nat (@instHAdd.{0} Nat instAddNat) N
                  (@OfNat.ofNat.{0} Nat (nat_lit 1) (instOfNatNat (nat_lit 1))))
                fun (i : Nat) =>
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] (μ : MeasureTheory.Measure Ω) (X : Nat → Ω → Real) (m σ : Real) (N : Nat),
  (∀ (i : Nat), AEMeasurable (X i) μ) → AEMeasurable (LocalDef003 X m σ N) μ
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] (μ : MeasureTheory.Measure Ω) (X : Nat → Ω → Real) (m σ : Real),
  (∀ (i : Nat), MeasureTheory.MemLp (X i) 2 μ) →
    ∀ (N : Nat), AEMeasurable (LocalDef003 X m σ (instHAdd.hAdd N 1)) μ
```
...
```lean
MeasureTheory.IsProbabilityMeasure LocalDef008
```
