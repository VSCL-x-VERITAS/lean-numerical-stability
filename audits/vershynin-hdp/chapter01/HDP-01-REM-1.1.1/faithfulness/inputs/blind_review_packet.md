...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  MeasureTheory.MemLp X 2 μ →
    MeasureTheory.MemLp Y 2 μ →
      Real.instLE.le (Real.norm.norm (LocalDef001 μ X Y))
        (instHMul.hMul (LocalDef002 μ X)
          (LocalDef002 μ Y))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  @LE.le.{0} Real Real.instLE
    (@Norm.norm.{0} Real Real.norm (@LocalDef001.{u_1} Ω inst μ X Y))
...
fun {Ω} [MeasurableSpace Ω] μ X Y =>
  LocalDef003 μ fun ω =>
    instHMul.hMul (instHSub.hSub (X ω) (LocalDef003 μ X))
      (instHSub.hSub (Y ω) (LocalDef003 μ Y))
```
...
fun {Ω} [MeasurableSpace Ω] μ X =>
  LocalDef003 μ fun ω =>
    instHPow.hPow (instHSub.hSub (X ω) (LocalDef003 μ X)) 2
```
