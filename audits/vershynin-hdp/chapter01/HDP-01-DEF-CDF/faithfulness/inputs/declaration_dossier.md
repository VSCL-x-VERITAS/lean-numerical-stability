# Declaration dossier for HDP-01-DEF-CDF
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  AEMeasurable X μ →
    ∀ (t : Real),
      Eq (NumStability.HDP.Scalar.Preliminaries.cdf μ X t)
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  @Eq.{1} ENNReal (@NumStability.HDP.Scalar.Preliminaries.cdf.{u_1} Ω inst μ X t)
...
### D002: `NumStability.HDP.Scalar.Preliminaries.distribution`
