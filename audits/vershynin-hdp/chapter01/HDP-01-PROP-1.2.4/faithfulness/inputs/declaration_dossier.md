# Declaration dossier for HDP-01-PROP-1.2.4
    ...
    Filter.Eventually (fun ω => Real.instLE.le 0 (X ω)) (MeasureTheory.ae μ) →
      MeasureTheory.Integrable X μ →
        ∀ {t : Real},
          Real.instLT.lt 0 t →
            And
              (Real.instLE.le (μ.real (Set.preimage X (Set.Ici t)))
                (instHDiv.hDiv (NumStability.HDP.Scalar.Preliminaries.expectation μ X) t))
  ...
  And
    (@LE.le.{0} Real Real.instLE
      ...
      (@HDiv.hDiv.{0, 0, 0} Real Real Real (@instHDiv.{0} Real (@DivInvMonoid.toDiv.{0} Real Real.instDivInvMonoid))
        (@NumStability.HDP.Scalar.Preliminaries.expectation.{u_1} Ω inst μ X) t))
