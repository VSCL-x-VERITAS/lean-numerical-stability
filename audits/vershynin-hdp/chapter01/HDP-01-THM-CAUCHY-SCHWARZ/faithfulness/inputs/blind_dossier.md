...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} {X Y : Ω → Real},
  MeasureTheory.MemLp X 2 μ →
    MeasureTheory.MemLp Y 2 μ →
      Real.instLE.le
        (Real.norm.norm (LocalDef001 μ fun ω => instHMul.hMul (X ω) (Y ω)))
        (instHMul.hMul (MeasureTheory.eLpNorm X 2 μ).toReal (MeasureTheory.eLpNorm Y 2 μ).toReal)
```
...
### D003: `AddMonoidWithOne.toNatCast`
...
### D016: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D017: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D032: `UniformSpace.toTopologicalSpace`
...
### D033: `instAddCommMonoidWithOneENNReal`
