  ...
  Measurable X →
    MeasureTheory.Integrable X μ →
      MeasureTheory.Integrable
          (fun ω => instHPow.hPow (instHSub.hSub (X ω) (LocalDef001 μ X)) 2) μ →
        ∀ {t : Real},
          Real.instLT.lt 0 t →
            have Y := fun ω =>
            ...
            And
              (Eq (Set.preimage Y (Set.Ici (instHPow.hPow t 2)))
                (setOf fun ω =>
                  GE.ge (abs (instHSub.hSub (X ω) (LocalDef001 μ X))) t))
              (And
                (Real.instLE.le (μ.real (Set.preimage Y (Set.Ici (instHPow.hPow t 2))))
                  (instHDiv.hDiv (LocalDef001 μ Y) (instHPow.hPow t 2)))
                (And
                  (Eq (LocalDef001 μ Y)
                    (LocalDef002 μ X))
                  (Real.instLE.le
                    (μ.real
                      (setOf fun ω =>
                        GE.ge (abs (instHSub.hSub (X ω) (LocalDef001 μ X))) t))
                    (instHDiv.hDiv (LocalDef002 μ X) (instHPow.hPow t 2)))))
```
    ...
    (And
      (@LE.le.{0} Real Real.instLE
        ...
        (@HDiv.hDiv.{0, 0, 0} Real Real Real (@instHDiv.{0} Real (@DivInvMonoid.toDiv.{0} Real Real.instDivInvMonoid))
          (@LocalDef001.{u_1} Ω inst μ Y)
          (@HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid)) t
            (@OfNat.ofNat.{0} Nat (nat_lit 2) (instOfNatNat (nat_lit 2))))))
      (And
        (@Eq.{1} Real (@LocalDef001.{u_1} Ω inst μ Y)
