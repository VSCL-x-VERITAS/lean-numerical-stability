# Declaration dossier for HDP-01-EQ-1.1
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] (μ : MeasureTheory.Measure Ω) [MeasureTheory.IsProbabilityMeasure μ]
  ...
  MeasureTheory.MemLp X 2 μ →
    MeasureTheory.MemLp Y 2 μ →
      And
        (Eq (NumStability.HDP.Scalar.Preliminaries.l2InnerProduct μ X Y)
          (NumStability.HDP.Scalar.Preliminaries.expectation μ fun ω => instHMul.hMul (X ω) (Y ω)))
        (Eq (NumStability.HDP.Scalar.Preliminaries.l2Norm μ X)
          (NumStability.HDP.Scalar.Preliminaries.expectation μ fun ω => instHPow.hPow (abs (X ω)) 2).sqrt)
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] (μ : @MeasureTheory.Measure.{u_1} Ω inst)
  ...
  (_hY :
    @MeasureTheory.MemLp.{u_1, 0} Ω Real inst
      ...
      μ),
  And
    (@Eq.{1} Real (@NumStability.HDP.Scalar.Preliminaries.l2InnerProduct.{u_1} Ω inst μ X Y)
    ...
    (@Eq.{1} Real (@NumStability.HDP.Scalar.Preliminaries.l2Norm.{u_1} Ω inst μ X)
      (Real.sqrt
        (@NumStability.HDP.Scalar.Preliminaries.expectation.{u_1} Ω inst μ fun (ω : Ω) =>
          @HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid))
            (@abs.{0} Real Real.lattice Real.instAddGroup (X ω))
...
### D002: `NumStability.HDP.Scalar.Preliminaries.l2InnerProduct`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.Preliminaries`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `0cb654330bb917ec7168c4a1c03cd0dbd4f5196e12c70d1d84f1cf506078ac35`
...
### D003: `NumStability.HDP.Scalar.Preliminaries.l2Norm`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.Preliminaries`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `12f6763d98b0fb43295fba13ea82fae4e191d70f188d5e4c6690203ee984a282`
...
fun {Ω} [MeasurableSpace Ω] μ X =>
  (NumStability.HDP.Scalar.Preliminaries.expectation μ fun ω => instHPow.hPow (X ω) 2).sqrt
```
...
### D018: `Nat.instAtLeastTwoHAddOfNat`
...
### D020: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D021: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D022: `NormedCommRing.toSeminormedCommRing`
...
### D024: `PseudoMetricSpace.toUniformSpace`
...
### D033: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D034: `SeminormedAddGroup.toContinuousENorm`
...
### D035: `SeminormedAddGroup.toPseudoMetricSpace`
...
### D037: `UniformSpace.toTopologicalSpace`
...
### D039: `instAddCommMonoidWithOneENNReal`
...
### D046: `NormedAddCommGroup.toSeminormedAddCommGroup`
