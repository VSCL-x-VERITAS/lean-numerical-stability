# Declaration dossier for HDP-01-CLAIM-STDEV
...
theorem hdp_01_hclaim_hstdev_spec
    ...
    l2Norm μ (fun ω => X ω - expectation μ X) =
      ...
      Real.sqrt (variance μ X) = standardDeviation μ X
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] (μ : MeasureTheory.Measure Ω) [MeasureTheory.IsProbabilityMeasure μ]
  ...
  MeasureTheory.MemLp X 2 μ →
    And
      (Eq
        (NumStability.HDP.Scalar.Preliminaries.l2Norm μ fun ω =>
          instHSub.hSub (X ω) (NumStability.HDP.Scalar.Preliminaries.expectation μ X))
        (NumStability.HDP.Scalar.Preliminaries.variance μ X).sqrt)
      (Eq (NumStability.HDP.Scalar.Preliminaries.variance μ X).sqrt
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] (μ : @MeasureTheory.Measure.{u_1} Ω inst)
  ...
  And
    (@Eq.{1} Real
      (@NumStability.HDP.Scalar.Preliminaries.l2Norm.{u_1} Ω inst μ fun (ω : Ω) =>
      ...
      (Real.sqrt (@NumStability.HDP.Scalar.Preliminaries.variance.{u_1} Ω inst μ X)))
    (@Eq.{1} Real (Real.sqrt (@NumStability.HDP.Scalar.Preliminaries.variance.{u_1} Ω inst μ X))
...
### D002: `NumStability.HDP.Scalar.Preliminaries.l2Norm`
...
### D003: `NumStability.HDP.Scalar.Preliminaries.standardDeviation`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.Preliminaries`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `9cd58e529aaefaf08b5dc437aba9f77195eadc2fc3468bdb4a91a65dcc20d1ba`
