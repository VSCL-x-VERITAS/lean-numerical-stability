# Declaration dossier for HDP-02-EX-2.4.2
...
∀ (p : Nat → (Set.Icc 0 1).Elem) (C : Real),
  Real.instLE.le 0 C →
    Filter.Eventually
        (fun n => Real.instLE.le (instHMul.hMul (instHSub.hSub n 1).cast (p n).val) (instHMul.hMul C (Real.log n.cast)))
        Filter.atTop →
      Filter.Eventually
        (fun n =>
          GE.ge
              ...
              (setOf fun G =>
                ∀ (v : Fin n),
                  Real.instLT.lt
                    ...
                    (instHMul.hMul (instHAdd.hAdd (instHMul.hMul 2 C) 5) (Real.log n.cast))))
            (9 / 10))
        Filter.atTop
```
