# Declaration dossier for HDP-02-REM-2.7.14
...
And
  (∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
    [MeasureTheory.IsProbabilityMeasure mu] {X : Omega → Real} {B : Real},
    Measurable X →
      Real.instLT.lt 0 B →
        Filter.Eventually (fun omega => Real.instLE.le (abs (X omega)) B) (MeasureTheory.ae mu) →
          ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu X) instTopENNReal.top)
  (∀ {Omega : Type u_2} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
    [MeasureTheory.IsProbabilityMeasure mu] {X : Omega → Real},
    Measurable X →
      ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu X) instTopENNReal.top →
        ∀ (p : Real), Real.instLE.le 1 p → MeasureTheory.Integrable (fun omega => instHPow.hPow (abs (X omega)) p) mu)
```
...
And
  (∀ {Omega : Type u_1} [inst : MeasurableSpace.{u_1} Omega] {mu : @MeasureTheory.Measure.{u_1} Omega inst}
    [@MeasureTheory.IsProbabilityMeasure.{u_1} Omega inst mu] {X : Omega → Real} {B : Real},
    @Measurable.{u_1, 0} Omega Real inst Real.measurableSpace X →
      @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) B →
        @Filter.Eventually.{u_1} Omega
            (fun (omega : Omega) =>
              @LE.le.{0} Real Real.instLE (@abs.{0} Real Real.lattice Real.instAddGroup (X omega)) B)
            (@MeasureTheory.ae.{u_1, u_1} Omega (@MeasureTheory.Measure.{u_1} Omega inst)
              (@MeasureTheory.Measure.instFunLike.{u_1} Omega inst)
              (@MeasureTheory.Measure.instOuterMeasureClass.{u_1} Omega inst) mu) →
          @LT.lt.{0} ENNReal
  ...
  (∀ {Omega : Type u_2} [inst : MeasurableSpace.{u_2} Omega] {mu : @MeasureTheory.Measure.{u_2} Omega inst}
    [@MeasureTheory.IsProbabilityMeasure.{u_2} Omega inst mu] {X : Omega → Real},
    @Measurable.{u_2, 0} Omega Real inst Real.measurableSpace X →
      @LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_2} Omega inst mu X)
          (@Top.top.{0} ENNReal instTopENNReal) →
        ∀ (p : Real),
            ...
            @MeasureTheory.Integrable.{0, u_2} Real
              ...
              (fun (omega : Omega) =>
                @HPow.hPow.{0, 0, 0} Real Real Real (@instHPow.{0, 0} Real Real Real.instPow)
                  (@abs.{0} Real Real.lattice Real.instAddGroup (X omega)) p)
              mu)
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hrem_h2_d7_d14`
...
- `NumStability.HDP.ContractSignatures.C_02_hrem_h2_d7_d14` imports: `NumStability.HDP.Scalar.SubGaussian`
...
### D016: `MeasureTheory.Measure.instFunLike`
...
### D017: `MeasureTheory.Measure.instOuterMeasureClass`
...
### D026: `PseudoMetricSpace.toUniformSpace`
...
### `NumStability.HDP.ContractSignatures.C_02_hrem_h2_d7_d14`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hrem_h2_d7_d14.lean`
SHA-256: `836c9811cf4b1f11d83e83d51020a8e7767594949cd29f2b478a5d72592d0b0b`
