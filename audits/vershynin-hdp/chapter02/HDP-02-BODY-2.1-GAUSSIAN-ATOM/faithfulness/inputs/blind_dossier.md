...
```lean
Eq
  (MeasureTheory.Measure.instFunLike.coe LocalDef001
    (Set.instSingletonSet.singleton 0))
  0
```
...
### D006: `MeasureTheory.Measure.instFunLike`
