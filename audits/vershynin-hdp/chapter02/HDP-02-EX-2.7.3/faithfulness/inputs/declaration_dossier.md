# Declaration dossier for HDP-02-EX-2.7.3
...
Exists fun C =>
  And (Real.instLE.le 1 C)
    (∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
      [MeasureTheory.IsProbabilityMeasure mu] {X : Omega → Real} {alpha : Real},
      Real.instLT.lt 0 alpha →
        ∀ (i j : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind) {Ki : Real},
          Real.instLT.lt 0 Ki →
            NumStability.HDP.Scalar.SubExponential.SubWeibullProperty mu X alpha i Ki →
              Exists fun Kj =>
                And (Real.instLT.lt 0 Kj)
                  (And (Real.instLE.le Kj (instHMul.hMul C Ki))
                    (NumStability.HDP.Scalar.SubExponential.SubWeibullProperty mu X alpha j Kj)))
```
...
@Exists.{1} Real fun (C : Real) =>
  And (@LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne)) C)
    (∀ {Omega : Type u_1} [inst : MeasurableSpace.{u_1} Omega] {mu : @MeasureTheory.Measure.{u_1} Omega inst}
      [@MeasureTheory.IsProbabilityMeasure.{u_1} Omega inst mu] {X : Omega → Real} {alpha : Real},
      @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) alpha →
        ∀ (i j : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind) {Ki : Real},
          @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) Ki →
            @NumStability.HDP.Scalar.SubExponential.SubWeibullProperty.{u_1} Omega inst mu X alpha i Ki →
              @Exists.{1} Real fun (Kj : Real) =>
                And
                  ...
                  (And
                    ...
                    (@NumStability.HDP.Scalar.SubExponential.SubWeibullProperty.{u_1} Omega inst mu X alpha j Kj)))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hex_h2_d7_d3`
...
- `NumStability.HDP.ContractSignatures.C_02_hex_h2_d7_d3` imports: `NumStability.HDP.Scalar.SubExponentialCharacterization`

## Semantic dependency inventory

`local` declarations are followed recursively through types and bodies. `external-frontier` declarations mark the one-level library trust boundary.

### D001: `NumStability.HDP.Scalar.SubExponential.SubWeibullProperty`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.SubExponential`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `a2e48dc3c17ba33450c4b294224b996209917e82d643dbd3a52e197503717162`
...
{Ω : Type u_1} →
  [inst : MeasurableSpace Ω] →
    MeasureTheory.Measure Ω →
      (Ω → Real) → Real → NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind → Real → Prop
```
...
{Ω : Type u_1} →
  [inst : MeasurableSpace.{u_1} Ω] →
    (μ : @MeasureTheory.Measure.{u_1} Ω inst) →
      (X : Ω → Real) → (α : Real) → NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind → Real → Prop
```

Definition body (one-level semantic boundary):

```lean
fun {Ω} [MeasurableSpace Ω] μ X α x x_1 =>
  NumStability.HDP.Scalar.SubExponential.SubWeibullProperty.match_1 (fun x x_2 => Prop) x x_1 fun i K =>
    And (Real.instLT.lt 0 α)
      (NumStability.HDP.Scalar.SubExponential.SubExponentialProperty μ (fun ω => instHPow.hPow (abs (X ω)) α) i K)
```

### D002: `NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.SubExponential`
- Declaration kind: `abbrev`
- Distance from target type: `1`
- Semantic SHA-256: `80ba2a731f132c41fc0a27c2474d91559f5a2f12694999ff6f265d2d0d76db18`
...
### D005: `NumStability.HDP.Scalar.SubExponential.SubWeibullProperty.match_1`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.SubExponential`
- Declaration kind: `abbrev`
- Distance from target type: `2`
- Semantic SHA-256: `b8bc13ec72d1f84c7028ff1f44baf58a21c7dd7b3c2459f924cec50ca6302f8f`

Type:

```lean
(motive : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind → Real → Sort u_1) →
  (x : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind) →
    (x_1 : Real) →
      ((i : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind) → (K : Real) → motive i K) → motive x x_1
```
...
(motive : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind → Real → Sort u_1) →
  (x : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind) →
    (x_1 : Real) →
      (h_1 : (i : NumStability.HDP.Scalar.SubExponential.SubWeibullPropertyKind) → (K : Real) → motive i K) →
        motive x x_1
```
...
```lean
fun motive x x_1 h_1 => h_1 x x_1
```

### D006: `NumStability.HDP.Scalar.SubExponential.SubExponentialAbsoluteMGFLocal`
...
### D007: `NumStability.HDP.Scalar.SubExponential.SubExponentialMomentBound`
...
### D008: `NumStability.HDP.Scalar.SubExponential.SubExponentialOnePointMGF`
...
### D009: `NumStability.HDP.Scalar.SubExponential.SubExponentialProperty.match_1`
...
### D010: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.absoluteMGF`
...
### D011: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.moment`
...
### D012: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.onePoint`
...
### D013: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.tail`
...
### D014: `NumStability.HDP.Scalar.SubExponential.SubExponentialTailBound`
...
### D015: `NumStability.HDP.Scalar.SubExponential.LpMomentGrowth`
...
### D016: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.casesOn`
...
### D017: `NumStability.HDP.Scalar.SubExponential.SubExponentialTailBound._proof_1`
...
### D018: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.rec`
...
### D047: `InnerProductSpace.toNormedSpace`
...
### D051: `MeasureTheory.Measure.real`
...
### D054: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D055: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D057: `NormedCommRing.toSeminormedCommRing`
...
### D059: `RCLike.toInnerProductSpaceReal`
...
### D070: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D071: `SeminormedAddGroup.toContinuousENorm`
...
### D072: `SeminormedCommRing.toNonUnitalSeminormedCommRing`
...
### D073: `UniformSpace.toTopologicalSpace`
...
### `NumStability.HDP.ContractSignatures.C_02_hex_h2_d7_d3`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hex_h2_d7_d3.lean`
SHA-256: `79494ff06c95eecf6019774ac2167624be79143606bb905dfda56b77e7e638ae`
