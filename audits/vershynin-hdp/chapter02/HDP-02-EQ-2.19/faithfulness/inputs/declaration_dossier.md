# Declaration dossier for HDP-02-EQ-2.19
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  MeasureTheory.MemLp X 2 μ →
    ENNReal.instPartialOrder.le
      (MeasureTheory.eLpNorm (fun ω => instHSub.hSub (X ω) (MeasureTheory.integral μ fun x => X x)) 2 μ)
      (MeasureTheory.eLpNorm X 2 μ)
```
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_heq_h2_d19`, `NumStability.HDP.Scalar.Preliminaries`
...
- `NumStability.HDP.ContractSignatures.C_02_heq_h2_d19` imports: `NumStability.HDP.Scalar.Preliminaries`
...
### D038: `instAddCommMonoidWithOneENNReal`
...
### `NumStability.HDP.ContractSignatures.C_02_heq_h2_d19`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_heq_h2_d19.lean`
SHA-256: `8f7c065a7c6c5484f5a638c35db4940a74484d7bf551f0c39f2652bc08c2add6`
