            ...
            (instHMul.hMul 2
              (Real.exp
                (instHDiv.hDiv (Real.instNeg.neg (instHPow.hPow t 2))
                  (instHPow.hPow (instHMul.hMul 2 (LocalDef001 μ X).toReal) 2))))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  @LE.le.{0} Real Real.instLE
    (@MeasureTheory.Measure.real.{u_1} Ω inst μ
      (@setOf.{u_1} Ω fun (ω : Ω) =>
        @GE.ge.{0} Real Real.instLE (@abs.{0} Real Real.lattice Real.instAddGroup (X ω)) t))
...
### D049: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D050: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D051: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D052: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D053: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D054: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D055: `ENNReal.instCompleteLinearOrder`
