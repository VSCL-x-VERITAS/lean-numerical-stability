# Declaration dossier for HDP-02-LEM-2.7.6
    ...
    And
      (Iff
        (ENNReal.instPartialOrder.lt
          (NumStability.HDP.Scalar.SubExponential.PsiOneGauge mu fun omega => instHPow.hPow (X omega) 2)
          instTopENNReal.top)
        (ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu X) instTopENNReal.top))
      (Eq (NumStability.HDP.Scalar.SubExponential.PsiOneGauge mu fun omega => instHPow.hPow (X omega) 2)
        (instHPow.hPow (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu X) 2))
```
        ...
        (@LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_1} Omega inst mu fun (omega : Omega) =>
            @HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid))
              (X omega) (@OfNat.ofNat.{0} Nat (nat_lit 2) (instOfNatNat (nat_lit 2))))
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d7_d6`
...
- `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d7_d6` imports: `NumStability.HDP.Scalar.SubExponential`
...
### D029: `Semiring.toMonoidWithZero`
...
### D053: `NormedAddCommGroup.toSeminormedAddCommGroup`
...
### D054: `NormedCommRing.toSeminormedCommRing`
...
### `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d7_d6`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hlem_h2_d7_d6.lean`
SHA-256: `701f24b9578fd58d21f253663aec4f3f3ef87218acf4495b466f2d99330e31e2`
