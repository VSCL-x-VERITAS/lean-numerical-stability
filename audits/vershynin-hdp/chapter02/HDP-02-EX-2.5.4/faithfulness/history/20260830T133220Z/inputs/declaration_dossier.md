# Declaration dossier for HDP-02-EX-2.5.4
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  [@MeasureTheory.IsProbabilityMeasure.{u_1} Ω inst μ] {X : Ω → Real} {K : Real}
  (hX :
              ...
              (@NonUnitalSeminormedRing.toSeminormedAddCommGroup.{0} Real
                (@NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing.{0} Real
                  (@SeminormedCommRing.toNonUnitalSeminormedCommRing.{0} Real
                    (@NormedCommRing.toSeminormedCommRing.{0} Real Real.normedCommRing))))))
          Ω inst
          (fun (ω : Ω) => Real.exp (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) lam (X ω))) μ)
          ...
          (Real.exp
            (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
              (@HPow.hPow.{0, 0, 0} Real Nat Real
                (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid)) K
...
### D005: `InnerProductSpace.toNormedSpace`
...
### D014: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D015: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D019: `PseudoMetricSpace.toUniformSpace`
