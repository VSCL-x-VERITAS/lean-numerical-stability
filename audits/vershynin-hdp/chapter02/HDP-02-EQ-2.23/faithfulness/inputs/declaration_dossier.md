# Declaration dossier for HDP-02-EQ-2.23
...
theorem hdp_02_heq_h2_d23
    ...
    μ {ω | ∑ i, X i ω ≥ t} ≤
      ENNReal.ofReal (Real.exp (-(lam * t))) *
        ∏ i, ∫⁻ ω, ENNReal.ofReal (Real.exp (lam * X i ω)) ∂μ
```
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  [MeasureTheory.IsProbabilityMeasure μ] {X : ι → Ω → Real},
              ...
              Real.instLT.lt 0 lam →
                Real.instLE.le 0 t →
                  ENNReal.instPartialOrder.le
                    (MeasureTheory.Measure.instFunLike.coe μ (setOf fun ω => GE.ge (Finset.univ.sum fun i => X i ω) t))
                    (instHMul.hMul (ENNReal.ofReal (Real.exp (Real.instNeg.neg (instHMul.hMul lam t))))
                      (Finset.univ.prod fun i =>
                        MeasureTheory.lintegral μ fun ω => ENNReal.ofReal (Real.exp (instHMul.hMul lam (X i ω)))))
```
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
  ...
  (hne : @Finset.Nonempty.{u_1} ι (@Finset.univ.{u_1} ι inst))
  ...
  (hSubExp :
    ∀ (i : ι),
      @LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
        (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_2} Ω inst_1 μ (X i))
  ...
  @LE.le.{0} ENNReal (@Preorder.toLE.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
    (@DFunLike.coe.{u_2 + 1, u_2 + 1, 1} (@MeasureTheory.Measure.{u_2} Ω inst_1) (Set.{u_2} Ω)
      (fun (x : Set.{u_2} Ω) => ENNReal) (@MeasureTheory.Measure.instFunLike.{u_2} Ω inst_1) μ
      (@setOf.{u_2} Ω fun (ω : Ω) =>
        @GE.ge.{0} Real Real.instLE
          (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) => X i ω) t))
      ...
      (ENNReal.ofReal
        (Real.exp
          (@Neg.neg.{0} Real Real.instNeg
            (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) lam t))))
      (@Finset.prod.{u_1, 0} ι ENNReal (@CommSemiring.toCommMonoid.{0} ENNReal ENNReal.instCommSemiring)
        (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
        @MeasureTheory.lintegral.{u_2} Ω inst_1 μ fun (ω : Ω) =>
          ENNReal.ofReal
            (Real.exp (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) lam (X i ω)))))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.Scalar.IndependentSums.Bernstein`
...
### D002: `NumStability.HDP.Scalar.SubExponential.PsiOneAdmissible`
...
### D003: `NumStability.HDP.Scalar.SubExponential.SubExponentialTailBound._proof_1`
...
### D005: `CommSemiring.toCommMonoid`
...
### D029: `MeasureTheory.Measure.instFunLike`
...
### D033: `NonAssocSemiring.toNonUnitalNonAssocSemiring`
...
### D034: `NonUnitalNonAssocSemiring.toDistrib`
...
### D059: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D060: `SeminormedAddGroup.toContinuousENorm`
...
### D070: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D071: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D072: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D073: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D074: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D075: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D076: `ENNReal.instCompleteLinearOrder`
