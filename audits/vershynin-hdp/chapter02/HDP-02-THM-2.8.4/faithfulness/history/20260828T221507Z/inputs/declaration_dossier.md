# Declaration dossier for HDP-02-THM-2.8.4
      ...
      (∀ (i : ι), And (MeasureTheory.Integrable (X i) μ) (Eq (MeasureTheory.integral μ fun ω => X i ω) 0)) →
        (∀ (i : ι), Filter.Eventually (fun ω => Real.instLE.le (abs (X i ω)) K) (MeasureTheory.ae μ)) →
          ProbabilityTheory.iIndepFun X μ →
            Real.instLT.lt 0 (Finset.univ.sum fun i => MeasureTheory.integral μ fun ω => instHPow.hPow (X i ω) 2) →
              ∀ {t : Real},
                Real.instLE.le 0 t →
      ...
      (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
        @MeasureTheory.integral.{u_2, 0} Ω Real Real.normedAddCommGroup
          ...
          @HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid))
            (X i ω) (@OfNat.ofNat.{0} Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))))
  {t : Real}
...
### D058: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D059: `SeminormedAddGroup.toContinuousENorm`
