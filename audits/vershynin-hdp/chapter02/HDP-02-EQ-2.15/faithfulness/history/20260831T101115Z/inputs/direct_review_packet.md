# Declaration dossier for HDP-02-EQ-2.15
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  @NumStability.HDP.Scalar.SubGaussian.LpMomentGrowth.{u_1} Ω inst μ X
    (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
      ...
      (ENNReal.toReal (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_1} Ω inst μ X)))
```
...
### D001: `NumStability.HDP.Scalar.SubGaussian.LpMomentGrowth`
...
### D015: `Nat.instAtLeastTwoHAddOfNat`
