...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  Measurable X →
    ENNReal.instPartialOrder.lt (LocalDef002 μ X) instTopENNReal.top →
      LocalDef001 μ X
        (instHMul.hMul (instHMul.hMul 16 (Real.exp 1)) (LocalDef002 μ X).toReal)
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  (hFinite :
    @LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
      (@LocalDef002.{u_1} Ω inst μ X) (@Top.top.{0} ENNReal instTopENNReal)),
  @LocalDef001.{u_1} Ω inst μ X
    (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
      ...
      (ENNReal.toReal (@LocalDef002.{u_1} Ω inst μ X)))
```
