# Declaration dossier for HDP-02-BODY-2.3-ONE-PLUS-X
...
```lean
∀ (x : Real), Real.instLE.le (instHAdd.hAdd 1 x) (Real.exp x)
```
...
- `AuditTarget` imports: `Mathlib.Analysis.SpecialFunctions.ExpDeriv`
