# Declaration dossier for HDP-02-EX-2.2.10B
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  [MeasureTheory.IsProbabilityMeasure μ] {X : ι → Ω → Real} {ε : Real},
  Real.instLT.lt 0 ε →
    (∀ (i : ι), Measurable (X i)) →
        ...
        (∀ (i : ι),
            And
              (MeasureTheory.Integrable
                (fun ω => Real.exp (instHMul.hMul (Real.instNeg.neg (instHDiv.hDiv 1 ε)) (X i ω))) μ)
              (Real.instLE.le
                (MeasureTheory.integral μ fun ω =>
                  Real.exp (instHMul.hMul (Real.instNeg.neg (instHDiv.hDiv 1 ε)) (X i ω)))
                ε)) →
          Real.instLE.le
            (μ.real
              (setOf fun ω => Real.instLE.le (Finset.univ.sum fun i => X i ω) (instHMul.hMul ε (Fintype.card ι).cast)))
            (instHPow.hPow (instHMul.hMul (Real.exp 1) ε) (Fintype.card ι))
```
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
  ...
  @LE.le.{0} Real Real.instLE
    ...
    (@HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid))
      (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
        (Real.exp (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne))) ε)
