...
∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
  ...
  Iff (ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubExponential.PsiOneGauge mu X) instTopENNReal.top)
    (Exists fun i =>
      Exists fun K => And (Real.instLT.lt 0 K) (NumStability.HDP.Scalar.SubExponential.SubExponentialProperty mu X i K))
```
...
∀ {Omega : Type u_1} [inst : MeasurableSpace.{u_1} Omega] {mu : @MeasureTheory.Measure.{u_1} Omega inst}
  ...
  Iff
    (@LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
      (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_1} Omega inst mu X) (@Top.top.{0} ENNReal instTopENNReal))
...
- `NumStability.HDP.ContractSignatures.C_02_hdef_h2_d7_d5` imports: `NumStability.HDP.Scalar.SubExponentialCharacterization`
...
SHA-256: `969ca169b596281afaa6e2090ec4f6a9909d40db9fcfa327edbc682606eb02fb`
