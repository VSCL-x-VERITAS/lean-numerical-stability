...
∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
  ...
  And
    (Iff
      (ENNReal.instPartialOrder.lt (LocalDef002 mu X)
        instTopENNReal.top)
      (Exists fun i =>
        Exists fun K =>
          And (Real.instLT.lt 0 K) (LocalDef003 mu X i K)))
    (Eq (LocalDef002 mu X)
