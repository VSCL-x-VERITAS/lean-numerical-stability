# Declaration dossier for HDP-02-DEF-2.7.5
...
∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
  ...
  And
    (Iff
      (ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeGauge mu X)
        instTopENNReal.top)
      (Exists fun i =>
        Exists fun K =>
          And (Real.instLT.lt 0 K) (NumStability.HDP.Scalar.SubExponential.SubExponentialProperty mu X i K)))
    (Eq (NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeGauge mu X)
      (ConditionallyCompleteLattice.toConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf.sInf
        (setOf fun t => NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeAdmissible mu X t)))
```
  ...
  And
    (Iff
      (@LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
        (@NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeGauge.{u_1} Omega inst mu X)
        (@Top.top.{0} ENNReal instTopENNReal))
      (@Exists.{1} NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind
        fun (i : NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind) =>
        @Exists.{1} Real fun (K : Real) =>
          And
            (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) K)
            (@NumStability.HDP.Scalar.SubExponential.SubExponentialProperty.{u_1} Omega inst mu X i K)))
    (@Eq.{1} ENNReal (@NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeGauge.{u_1} Omega inst mu X)
      (@InfSet.sInf.{0} ENNReal
        ...
        (@setOf.{0} ENNReal fun (t : ENNReal) =>
          @NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeAdmissible.{u_1} Omega inst mu X t)))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hdef_h2_d7_d5`
...
- `NumStability.HDP.Scalar.SubExponentialPropertyThreeGauge` imports: `NumStability.HDP.Scalar.SubExponentialCharacterization`
- `NumStability.HDP.ContractSignatures.C_02_hdef_h2_d7_d5` imports: `NumStability.HDP.Scalar.SubExponentialPropertyThreeGauge`

## Semantic dependency inventory

`local` declarations are followed recursively through types and bodies. `external-frontier` declarations mark the one-level library trust boundary.

### D001: `NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeAdmissible`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.SubExponentialPropertyThreeGauge`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `556fd3711aa1adb207c7bc917c0cc98e4e566f22b68d8051ee36078ffc7d744b`

Type:

```lean
{Omega : Type u_1} → [inst : MeasurableSpace Omega] → MeasureTheory.Measure Omega → (Omega → Real) → ENNReal → Prop
```
...
{Omega : Type u_1} →
  [inst : MeasurableSpace.{u_1} Omega] →
    (mu : @MeasureTheory.Measure.{u_1} Omega inst) → (X : Omega → Real) → (t : ENNReal) → Prop
```

Definition body (one-level semantic boundary):

```lean
fun {Omega} [MeasurableSpace Omega] mu X t =>
  And (Ne t 0)
    (And (Ne t instTopENNReal.top)
      (NumStability.HDP.Scalar.SubExponential.SubExponentialAbsoluteMGFLocal mu X t.toReal))
```

### D002: `NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeGauge`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.SubExponentialPropertyThreeGauge`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `336636b6cb92a8a72ee408ef4c186981242f6df2b821a59ce9b9c52d622d8171`

Type:

```lean
{Omega : Type u_1} → [inst : MeasurableSpace Omega] → MeasureTheory.Measure Omega → (Omega → Real) → ENNReal
```
...
```lean
{Omega : Type u_1} →
  [inst : MeasurableSpace.{u_1} Omega] → (mu : @MeasureTheory.Measure.{u_1} Omega inst) → (X : Omega → Real) → ENNReal
```

Definition body (one-level semantic boundary):

```lean
fun {Omega} [MeasurableSpace Omega] mu X =>
  ConditionallyCompleteLattice.toConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf.sInf
    (setOf fun t => NumStability.HDP.Scalar.SubExponential.PsiOnePropertyThreeAdmissible mu X t)
```

### D003: `NumStability.HDP.Scalar.SubExponential.SubExponentialProperty`
...
### D004: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind`
...
### D005: `NumStability.HDP.Scalar.SubExponential.SubExponentialAbsoluteMGFLocal`
...
### D006: `NumStability.HDP.Scalar.SubExponential.SubExponentialMomentBound`
...
### D007: `NumStability.HDP.Scalar.SubExponential.SubExponentialOnePointMGF`
...
### D008: `NumStability.HDP.Scalar.SubExponential.SubExponentialProperty.match_1`
...
### D009: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.absoluteMGF`
...
### D011: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.onePoint`
...
### D012: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.tail`
...
### D013: `NumStability.HDP.Scalar.SubExponential.SubExponentialTailBound`
...
### D014: `NumStability.HDP.Scalar.SubExponential.LpMomentGrowth`
...
### D015: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.casesOn`
...
### D016: `NumStability.HDP.Scalar.SubExponential.SubExponentialTailBound._proof_1`
...
### D017: `NumStability.HDP.Scalar.SubExponential.SubExponentialPropertyKind.rec`
...
### D019: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D020: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D021: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D022: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D023: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D024: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D026: `ENNReal.instCompleteLinearOrder`
...
### D034: `MeasureTheory.IsProbabilityMeasure`
...
### D059: `MeasureTheory.Measure.real`
...
### D062: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D063: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D065: `NormedCommRing.toSeminormedCommRing`
...
### D066: `PseudoMetricSpace.toUniformSpace`
...
### D067: `RCLike.toInnerProductSpaceReal`
...
### `NumStability.HDP.Scalar.IndependentSums.Bernstein`

Path: `lean-numerical-stability/NumStability/HDP/Scalar/IndependentSums/Bernstein.lean`
SHA-256: `75f95d4891e3ba80a9ff155b4501f1e08172d525dd278570ec40a7c39c3fe3c5`
...
### `NumStability.HDP.Scalar.SubExponentialCharacterization`

Path: `lean-numerical-stability/NumStability/HDP/Scalar/SubExponentialCharacterization.lean`
SHA-256: `0bc8893f75ff52af3a0fb0308ec8e2ed5997af1a5b0497c16fff715c00c1364d`
...
### `NumStability.HDP.Scalar.SubExponentialPropertyThreeGauge`

Path: `lean-numerical-stability/NumStability/HDP/Scalar/SubExponentialPropertyThreeGauge.lean`
SHA-256: `01ba599817952ad348e1ef3d9a9d992d80a4d386fcf154507f9ca3ba5b43ca25`
...
### `NumStability.HDP.ContractSignatures.C_02_hdef_h2_d7_d5`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hdef_h2_d7_d5.lean`
SHA-256: `81b7f3818c54be61d63c853de8a7e8065da3b83190c765d21096fb16db8f426a`
