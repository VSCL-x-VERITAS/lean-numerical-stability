    ...
    (∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
      ...
      (∀ (i : ι), NumStability.HDP.Scalar.SubGaussian.IsSubGaussian μ (X i)) →
        (∀ (i : ι), And (MeasureTheory.Integrable (X i) μ) (Eq (MeasureTheory.integral μ fun ω => X i ω) 0)) →
          ProbabilityTheory.iIndepFun X μ →
            And (NumStability.HDP.Scalar.SubGaussian.IsSubGaussian μ fun ω => Finset.univ.sum fun i => X i ω)
              (Real.instLE.le
                (instHPow.hPow
                  (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm μ fun ω => Finset.univ.sum fun i => X i ω).toReal 2)
                (instHMul.hMul C
...
@Exists.{1} Real fun (C : Real) =>
  And (@LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne)) C)
    (∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
      ...
      {X : ι → Ω → Real},
      (∀ (i : ι), @NumStability.HDP.Scalar.SubGaussian.IsSubGaussian.{u_2} Ω inst_1 μ (X i)) →
        (∀ (i : ι),
            And
          ...
          @ProbabilityTheory.iIndepFun.{u_2, u_1, 0} Ω ι inst_1 (fun (x : ι) => Real)
            ...
            And
              (@NumStability.HDP.Scalar.SubGaussian.IsSubGaussian.{u_2} Ω inst_1 μ fun (ω : Ω) =>
              ...
              (@LE.le.{0} Real Real.instLE
                (@HPow.hPow.{0, 0, 0} Real Nat Real
                  ...
                  (ENNReal.toReal
                    (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_2} Ω inst_1 μ fun (ω : Ω) =>
                ...
                (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) C
                  (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
                    @HPow.hPow.{0, 0, 0} Real Nat Real
                      (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid))
                      (ENNReal.toReal (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_2} Ω inst_1 μ (X i)))
                      (@OfNat.ofNat.{0} Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))))))
```
...
### D031: `ProbabilityTheory.iIndepFun`
...
### D058: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D059: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D060: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D061: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D062: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D063: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D065: `ENNReal.instCompleteLinearOrder`
