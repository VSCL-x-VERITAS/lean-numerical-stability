# Declaration dossier for HDP-02-PROP-2.6.1
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  [MeasureTheory.IsProbabilityMeasure μ] {X : ι → Ω → Real} {K : ι → Real},
  (∀ (i : ι), NumStability.HDP.Scalar.SubGaussian.SubGaussianLinearMGF μ (X i) (K i)) →
    ProbabilityTheory.iIndepFun X μ →
      Real.instLT.lt 0 (Finset.univ.sum fun i => instHPow.hPow (K i) 2) →
        Exists fun C =>
          And (Real.instLE.le 1 C)
            (And
              (NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty μ (fun ω => Finset.univ.sum fun i => X i ω)
                NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.linearMGF
                (Finset.univ.sum fun i => instHPow.hPow (K i) 2).sqrt)
              (ENNReal.instPartialOrder.le
                (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge μ fun ω => Finset.univ.sum fun i => X i ω)
                (ENNReal.ofReal (instHMul.hMul C (Finset.univ.sum fun i => instHPow.hPow (K i) 2).sqrt))))
```
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
  ...
  {K : ι → Real}
  (hX : ∀ (i : ι), @NumStability.HDP.Scalar.SubGaussian.SubGaussianLinearMGF.{u_2} Ω inst_1 μ (X i) (K i))
  (hIndep :
  ...
  (hEnergy :
    @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))
      (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
        @HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid)) (K i)
  ...
  @Exists.{1} Real fun (C : Real) =>
    And (@LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne)) C)
      (And
        (@NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty.{u_2} Ω inst_1 μ
          (fun (ω : Ω) =>
          ...
          (Real.sqrt
            (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
              @HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid))
                (K i) (@OfNat.ofNat.{0} Nat (nat_lit 2) (instOfNatNat (nat_lit 2))))))
        (@LE.le.{0} ENNReal (@Preorder.toLE.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_2} Ω inst_1 μ fun (ω : Ω) =>
            @Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) => X i ω)
          (ENNReal.ofReal
...
### D002: `NumStability.HDP.Scalar.SubGaussian.SubGaussianLinearMGF`
...
### D004: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.linearMGF`
...
### D006: `NumStability.HDP.Scalar.SubGaussian.SubGaussianMomentBound`
...
### D007: `NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty.match_1`
...
### D008: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind`
...
### D009: `NumStability.HDP.Scalar.SubGaussian.SubGaussianSquarePoint`
...
### D010: `NumStability.HDP.Scalar.SubGaussian.SubGaussianSquareWindow`
...
### D011: `NumStability.HDP.Scalar.SubGaussian.SubGaussianTailBound`
...
### D012: `NumStability.HDP.Scalar.SubGaussian.EvenMomentBound._proof_1`
...
### D013: `NumStability.HDP.Scalar.SubGaussian.LpMomentGrowth`
...
### D014: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.casesOn`
...
### D033: `MeasureTheory.IsProbabilityMeasure`
...
### D041: `ProbabilityTheory.iIndepFun`
...
### D062: `ENNReal.instCompleteLinearOrder`
...
### D091: `MeasureTheory.Measure.real`
