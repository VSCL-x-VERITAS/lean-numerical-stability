# Declaration dossier for HDP-02-EX-2.5.9
...
```lean
theorem hdp_02_hex_h2_d5_d9 : hdp_02_hex_h2_d5_d9__contract_type
```

## Elaborated target type

```lean
NumStability.HDP.Contract.hdp_02_hex_h2_d5_d9__contract_type
```
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hex_h2_d5_d9`, `NumStability.HDP.Scalar.NonSubGaussian`
...
- `NumStability.HDP.Scalar.NonSubGaussian` imports: `NumStability.HDP.Scalar.SubExponential`, `NumStability.HDP.Scalar.SubGaussian`, `NumStability.HDP.Scalar.IndependentSums.PoissonChernoff`
- `NumStability.HDP.ContractSignatures.C_02_hex_h2_d5_d9` imports: `NumStability.HDP.Scalar.NonSubGaussian`

## Semantic dependency inventory

`local` declarations are followed recursively through types and bodies. `external-frontier` declarations mark the one-level library trust boundary.

### D001: `NumStability.HDP.Contract.hdp_02_hex_h2_d5_d9__contract_type`

- Role: `local`
- Owner module: `NumStability.HDP.ContractSignatures.C_02_hex_h2_d5_d9`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `3a062e2ae6474ebcf5b906449cd7a703a296d0556def355b8be086b195b36680`
...
And
  (∀ (rate : NNReal),
    instPartialOrderNNReal.lt 0 rate →
      Eq (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (ProbabilityTheory.poissonMeasure rate) fun n => n.cast)
        instTopENNReal.top)
  (And
    (∀ (rate : Real),
      Real.instLT.lt 0 rate →
        Eq (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (ProbabilityTheory.expMeasure rate) id) instTopENNReal.top)
    (And
      (∀ (shape scale : NNReal),
        instPartialOrderNNReal.lt 0 shape →
          instPartialOrderNNReal.lt 0 scale →
            Eq
              (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge
                (NumStability.HDP.Scalar.SubGaussian.paretoMeasure shape scale) id)
              instTopENNReal.top)
      (∀ (loc : Real) (scale : NNReal),
        instPartialOrderNNReal.lt 0 scale →
          Eq
            (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge
              (NumStability.HDP.Scalar.SubGaussian.cauchyLocationScaleMeasure loc scale) id)
            instTopENNReal.top)))
```

### D002: `NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge`
...
### D003: `NumStability.HDP.Scalar.SubGaussian.cauchyLocationScaleMeasure`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.NonSubGaussian`
- Declaration kind: `def`
- Distance from target type: `2`
- Semantic SHA-256: `54d79e31f5ba8ad126de71850f53e1daf4f12f2a25f4989a0ca7981d31117fc8`
...
```lean
(loc : Real) → (scale : NNReal) → @MeasureTheory.Measure.{0} Real Real.measurableSpace
```
...
```lean
fun loc scale =>
  MeasureTheory.Measure.map (fun x => instHAdd.hAdd loc (instHMul.hMul scale.toReal x)) (Probability.cauchyMeasure 0 1)
```

### D004: `NumStability.HDP.Scalar.SubGaussian.paretoMeasure`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.NonSubGaussian`
- Declaration kind: `def`
- Distance from target type: `2`
- Semantic SHA-256: `9ddf37ed6a52c80bfa38ed61cc04b012f45f34e43e2c7801adb32659ca24e90b`

Type:

```lean
NNReal → NNReal → MeasureTheory.Measure Real
```

Fully explicit type:

```lean
(shape scale : NNReal) → @MeasureTheory.Measure.{0} Real Real.measurableSpace
```
...
```lean
fun shape scale =>
  MeasureTheory.Measure.map (fun x => instHMul.hMul scale.toReal (Real.exp x))
    (ProbabilityTheory.expMeasure shape.toReal)
```
...
### D018: `ProbabilityTheory.expMeasure`
...
### D019: `ProbabilityTheory.poissonMeasure`
...
### D031: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D032: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D033: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D034: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D035: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D036: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D037: `ENNReal.instCompleteLinearOrder`
...
### D043: `MeasureTheory.Measure.map`
...
### D046: `Probability.cauchyMeasure`
...
### D058: `InnerProductSpace.toNormedSpace`
...
### D067: `NormedAddCommGroup.toSeminormedAddCommGroup`
...
### D068: `NormedCommRing.toSeminormedCommRing`
...
### D070: `RCLike.toInnerProductSpaceReal`
...
SHA-256: `250fb0d79d95c6f86b958282e0a7de07f2501e6c8435e9e590e1935864fc22f4`
...
### `NumStability.HDP.Scalar.NonSubGaussian`

Path: `lean-numerical-stability/NumStability/HDP/Scalar/NonSubGaussian.lean`
SHA-256: `2aa2b26a18315fee196d81504be395f162213eb06a6ffeb0d065234fea5e11c2`
...
### `NumStability.HDP.ContractSignatures.C_02_hex_h2_d5_d9`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hex_h2_d5_d9.lean`
SHA-256: `6374034a3cd972f76a5adaaf744689cde77a171d98b95e24ce7620615d777551`
