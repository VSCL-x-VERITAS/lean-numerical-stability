...
And
  (∀ (rate : NNReal),
    instPartialOrderNNReal.lt 0 rate →
      Eq (LocalDef002 (ProbabilityTheory.poissonMeasure rate) fun n => n.cast)
        instTopENNReal.top)
  (And
    (∀ (rate : Real),
      Real.instLT.lt 0 rate →
        Eq (LocalDef002 (ProbabilityTheory.expMeasure rate) id) instTopENNReal.top)
    (And
      (∀ (shape scale : NNReal),
        instPartialOrderNNReal.lt 0 shape →
          instPartialOrderNNReal.lt 0 scale →
            Eq
              (LocalDef002
                (LocalDef004 shape scale) id)
              instTopENNReal.top)
      (∀ (loc : Real) (scale : NNReal),
        instPartialOrderNNReal.lt 0 scale →
          Eq
            (LocalDef002
              (LocalDef003 loc scale) id)
            instTopENNReal.top)))
```
