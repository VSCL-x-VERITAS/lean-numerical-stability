...
- Semantic SHA-256: `97f56bdb8e63443253657fb8ab7e2cc86d3a9f4768fe45b4274f39099fc03419`
  ...
  (∀ (rate : NNReal),
    instPartialOrderNNReal.lt 0 rate →
      Eq (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (ProbabilityTheory.poissonMeasure rate) fun n => n.cast)
        instTopENNReal.top)
  (And (Eq (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (ProbabilityTheory.expMeasure 1) id) instTopENNReal.top)
    (And
      (Eq
        (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge
          (MeasureTheory.Measure.map Real.exp (ProbabilityTheory.expMeasure 1)) id)
        instTopENNReal.top)
      (Eq (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (Probability.cauchyMeasure 0 1) id) instTopENNReal.top)))
```
...
### D003: `NumStability.HDP.Scalar.SubGaussian.PsiTwoAdmissible`
...
### D004: `NumStability.HDP.Scalar.SubGaussian.EvenMomentBound._proof_1`
...
### D009: `MeasureTheory.Measure.map`
...
### D018: `Probability.cauchyMeasure`
...
### D019: `ProbabilityTheory.expMeasure`
...
### D020: `ProbabilityTheory.poissonMeasure`
...
### D049: `InnerProductSpace.toNormedSpace`
...
### D059: `NormedCommRing.toSeminormedCommRing`
...
SHA-256: `65bb5d0108aabc510d1f0e407b729b9665a491a3094d3175882a74064aab25a4`
...
finite `ψ₂` gauge and applies them to the rate-one exponential law and the
standard Cauchy law.  These are distributional obstructions needed for
Exercise 2.5.9.
-/
...
/-- The scale-one, shape-one Pareto law, realized as the exponential of a
rate-one exponential random variable. -/
...
SHA-256: `6031ba8b88e60f2281a723e4335449db6807956dbcd705823818e865b92e2d4d`
...
This proof-free signature records canonical members of the four distribution
families named in the exercise. The Poisson assertion covers every positive
rate; the other assertions use the rate-one exponential,
scale-one/shape-one Pareto, and standard Cauchy laws.
-/
...
def hdp_02_hex_h2_d5_d9__contract_type : Prop :=
  ...
  NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (expMeasure 1) id = ∞ ∧
  NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge
      ((expMeasure 1).map Real.exp) id = ∞ ∧
  NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge
      (Probability.cauchyMeasure 0 1) id = ∞
