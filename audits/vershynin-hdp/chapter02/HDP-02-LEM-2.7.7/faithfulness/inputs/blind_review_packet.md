...
∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
  ...
  ENNReal.instPartialOrder.lt (LocalDef002 mu X) instTopENNReal.top →
    ENNReal.instPartialOrder.lt (LocalDef002 mu Y) instTopENNReal.top →
      And
        (ENNReal.instPartialOrder.lt
          (LocalDef001 mu fun omega => instHMul.hMul (X omega) (Y omega))
          instTopENNReal.top)
        (ENNReal.instPartialOrder.le
          (LocalDef001 mu fun omega => instHMul.hMul (X omega) (Y omega))
          (instHMul.hMul (LocalDef002 mu X)
            (LocalDef002 mu Y)))
```
...
∀ {Omega : Type u_1} [inst : MeasurableSpace.{u_1} Omega] {mu : @MeasureTheory.Measure.{u_1} Omega inst}
  ...
  @LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
      (@LocalDef002.{u_1} Omega inst mu X) (@Top.top.{0} ENNReal instTopENNReal) →
    @LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
        (@LocalDef002.{u_1} Omega inst mu Y) (@Top.top.{0} ENNReal instTopENNReal) →
      And
        (@LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          (@LocalDef001.{u_1} Omega inst mu fun (omega : Omega) =>
        ...
        (@LE.le.{0} ENNReal (@Preorder.toLE.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          ...
          (@HMul.hMul.{0, 0, 0} ENNReal ENNReal ENNReal
            ...
            (@LocalDef002.{u_1} Omega inst mu Y)))
```
