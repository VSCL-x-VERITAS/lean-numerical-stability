# Declaration dossier for HDP-02-LEM-2.7.7
...
∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
  [MeasureTheory.IsProbabilityMeasure mu] {X Y : Omega → Real},
  ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu X) instTopENNReal.top →
    ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu Y) instTopENNReal.top →
      And
        (ENNReal.instPartialOrder.lt
          (NumStability.HDP.Scalar.SubExponential.PsiOneGauge mu fun omega => instHMul.hMul (X omega) (Y omega))
          instTopENNReal.top)
        (ENNReal.instPartialOrder.le
          (NumStability.HDP.Scalar.SubExponential.PsiOneGauge mu fun omega => instHMul.hMul (X omega) (Y omega))
          (instHMul.hMul (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu X)
            (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge mu Y)))
```
...
∀ {Omega : Type u_1} [inst : MeasurableSpace.{u_1} Omega] {mu : @MeasureTheory.Measure.{u_1} Omega inst}
  [@MeasureTheory.IsProbabilityMeasure.{u_1} Omega inst mu] {X Y : Omega → Real},
  @LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
      (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_1} Omega inst mu X) (@Top.top.{0} ENNReal instTopENNReal) →
    @LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
        (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_1} Omega inst mu Y) (@Top.top.{0} ENNReal instTopENNReal) →
      And
        (@LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_1} Omega inst mu fun (omega : Omega) =>
            @HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) (X omega) (Y omega))
        ...
        (@LE.le.{0} ENNReal (@Preorder.toLE.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          ...
          (@HMul.hMul.{0, 0, 0} ENNReal ENNReal ENNReal
            ...
            (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_1} Omega inst mu X)
            (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_1} Omega inst mu Y)))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d7_d7`
...
- `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d7_d7` imports: `NumStability.HDP.Scalar.SubExponential`

## Semantic dependency inventory

`local` declarations are followed recursively through types and bodies. `external-frontier` declarations mark the one-level library trust boundary.

### D001: `NumStability.HDP.Scalar.SubExponential.PsiOneGauge`
...
### D019: `NonAssocSemiring.toNonUnitalNonAssocSemiring`
...
### D020: `NonUnitalNonAssocSemiring.toDistrib`
...
### D026: `Semiring.toNonAssocSemiring`
...
### D030: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D031: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D032: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D033: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D034: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D035: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D036: `ENNReal.instCompleteLinearOrder`
...
### D043: `InnerProductSpace.toNormedSpace`
...
### D050: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D051: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D053: `NormedCommRing.toSeminormedCommRing`
...
### `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d7_d7`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hlem_h2_d7_d7.lean`
SHA-256: `c1142fd75c3e551818e280aed1061eee8366196993b4c0ff1fc3acee13c097c7`
