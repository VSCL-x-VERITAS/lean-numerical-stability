# Declaration dossier for HDP-02-PROP-2.1.2
    ...
    And
      (Real.instLE.le
        (instHMul.hMul (Real.instInv.inv (instHMul.hMul 2 Real.pi).sqrt)
          (instHMul.hMul (instHSub.hSub (instHDiv.hDiv 1 t) (instHDiv.hDiv 1 (instHPow.hPow t 3)))
      ...
      (Real.instLE.le (NumStability.HDP.Scalar.LimitTheorems.standardNormalLaw.real (Set.Ici t))
        (instHMul.hMul (Real.instInv.inv (instHMul.hMul 2 Real.pi).sqrt)
          (instHMul.hMul (instHDiv.hDiv 1 t) (Real.exp (instHDiv.hDiv (Real.instNeg.neg (instHPow.hPow t 2)) 2)))))
```
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hprop_h2_d1_d2`, `NumStability.HDP.Scalar.GaussianTails`
...
- `NumStability.HDP.ContractSignatures.C_02_hprop_h2_d1_d2` imports: `NumStability.HDP.Scalar.LimitTheorems`
...
### D011: `MeasureTheory.Measure.real`
...
### D046: `ProbabilityTheory.gaussianReal`
...
### `NumStability.HDP.ContractSignatures.C_02_hprop_h2_d1_d2`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hprop_h2_d1_d2.lean`
SHA-256: `807a75517e8692dd4fddd34a18db3abf7193d0cfad3d0d57687b60c5ab3952f9`
...
SHA-256: `1a43f45f7c442c5681b7fa8c8dee9fcb23246ed67a3342efc45e5c6b23579882`
