# Declaration dossier for HDP-02-BODY-2.2-COIN-BOUND
      ...
      (∀ (i : ι),
        ...
        instLTNat.lt 0 (Fintype.card ι) →
          Real.instLE.le
            ...
            (Real.exp (instHDiv.hDiv (Real.instNeg.neg (Fintype.card ι).cast) 8))
```
  ...
  @LE.le.{0} Real Real.instLE
    ...
    (Real.exp
      (@HDiv.hDiv.{0, 0, 0} Real Real Real (@instHDiv.{0} Real (@DivInvMonoid.toDiv.{0} Real Real.instDivInvMonoid))
        (@Neg.neg.{0} Real Real.instNeg (@Nat.cast.{0} Real Real.instNatCast (@Fintype.card.{u_1} ι inst)))
