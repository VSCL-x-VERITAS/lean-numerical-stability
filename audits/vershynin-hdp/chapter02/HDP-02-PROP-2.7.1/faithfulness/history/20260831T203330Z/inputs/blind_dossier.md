...
Exists fun C =>
  And (Real.instLE.le 1 C)
    (∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
      ...
      And
        (∀ (i j : LocalDef003) {Ki : Real},
          Real.instLT.lt 0 Ki →
            LocalDef002 mu X i Ki →
              Exists fun Kj =>
                And (Real.instLT.lt 0 Kj)
                  (And (Real.instLE.le Kj (instHMul.hMul C Ki))
                    (LocalDef002 mu X j Kj)))
      ...
      And
        (∀ (i j : LocalDef003) {Ki : Real},
          @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) Ki →
            @LocalDef002.{u_1} Omega inst mu X i Ki →
              @Exists.{1} Real fun (Kj : Real) =>
                And
                  ...
                  (And
                    ...
                    (@LocalDef002.{u_1} Omega inst mu X j Kj)))
        (And
                  ...
                  @Exists.{1} Real fun (K5 : Real) =>
                    And
                      ...
                      (And
                        ...
                        (@LocalDef001.{u_1} Omega inst mu
                          X K5)))
            (∀ {K5 : Real},
              @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))
                  K5 →
                @LocalDef001.{u_1} Omega inst mu X K5 →
...
fun motive x h_1 h_2 h_3 h_4 =>
  LocalDef014 x (h_1 Unit.unit) (h_2 Unit.unit)
...
fun {motive} t tail moment absoluteMGF onePoint =>
  LocalDef016 tail moment absoluteMGF onePoint t
```
