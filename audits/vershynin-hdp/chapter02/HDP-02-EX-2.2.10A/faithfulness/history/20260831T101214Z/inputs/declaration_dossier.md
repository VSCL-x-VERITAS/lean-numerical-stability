# Declaration dossier for HDP-02-EX-2.2.10A
...
```lean
∀ {f : Real → Real},
  NumStability.HDP.Scalar.IndependentSums.Hoeffding.BoundedDensityOnNonnegative f →
    ∀ {t : Real},
      Real.instLT.lt 0 t →
        Real.instLE.le
          (MeasureTheory.integral Real.measureSpace.volume fun x =>
            instHMul.hMul (Real.exp (instHMul.hMul (Real.instNeg.neg t) x)) (f x))
          (instHDiv.hDiv 1 t)
```
...
```lean
∀ {f : Real → Real} (hf : NumStability.HDP.Scalar.IndependentSums.Hoeffding.BoundedDensityOnNonnegative f) {t : Real}
  ...
  @LE.le.{0} Real Real.instLE
    (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
      ...
      @HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
        (Real.exp
          (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) (@Neg.neg.{0} Real Real.instNeg t) x))
        (f x))
...
### D001: `NumStability.HDP.Scalar.IndependentSums.Hoeffding.BoundedDensityOnNonnegative`

- Role: `local`
- Owner module: `AuditTarget`
- Declaration kind: `inductive`
- Distance from target type: `1`
- Semantic SHA-256: `88908c35ae491704a956ab039241e070c44866120bdd17ec0d69c488c731515f`
...
### D002: `NumStability.HDP.Scalar.IndependentSums.Hoeffding.BoundedDensityOnNonnegative.mk`

- Role: `local`
- Owner module: `AuditTarget`
- Declaration kind: `constructor`
- Distance from target type: `2`
- Semantic SHA-256: `227472c0fa923ca44238c360726ad82b33d3c27b38b288e971f9a33ced93a39d`

Type:

```lean
∀ {f : Real → Real},
  Filter.Eventually (fun x => Real.instLE.le 0 (f x)) (MeasureTheory.ae Real.measureSpace.volume) →
    Filter.Eventually (fun x => Real.instLT.lt x 0 → Eq (f x) 0) (MeasureTheory.ae Real.measureSpace.volume) →
      Filter.Eventually (fun x => Real.instLE.le 0 x → Real.instLE.le (f x) 1)
          (MeasureTheory.ae Real.measureSpace.volume) →
        MeasureTheory.Integrable f Real.measureSpace.volume →
          Eq (MeasureTheory.integral Real.measureSpace.volume fun x => f x) 1 →
            NumStability.HDP.Scalar.IndependentSums.Hoeffding.BoundedDensityOnNonnegative f
```
...
∀ {f : Real → Real}
  (nonnegative :
    @Filter.Eventually.{0} Real
      (fun (x : Real) =>
        @LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) (f x))
    ...
    @Filter.Eventually.{0} Real
      (fun (x : Real) =>
        @LT.lt.{0} Real Real.instLT x (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) →
          @Eq.{1} Real (f x) (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)))
      (@MeasureTheory.ae.{0, 0} Real
        (@MeasureTheory.Measure.{0} Real (@MeasureTheory.MeasureSpace.toMeasurableSpace.{0} Real Real.measureSpace))
        (@MeasureTheory.Measure.instFunLike.{0} Real
          (@MeasureTheory.MeasureSpace.toMeasurableSpace.{0} Real Real.measureSpace))
    ...
    @Filter.Eventually.{0} Real
      (fun (x : Real) =>
        @LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) x →
          @LE.le.{0} Real Real.instLE (f x) (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne)))
      (@MeasureTheory.ae.{0, 0} Real
        (@MeasureTheory.Measure.{0} Real (@MeasureTheory.MeasureSpace.toMeasurableSpace.{0} Real Real.measureSpace))
        (@MeasureTheory.Measure.instFunLike.{0} Real
          (@MeasureTheory.MeasureSpace.toMeasurableSpace.{0} Real Real.measureSpace))
  ...
  (integrable :
    @MeasureTheory.Integrable.{0, 0} Real
      ...
      Real (@MeasureTheory.MeasureSpace.toMeasurableSpace.{0} Real Real.measureSpace) f
      (@MeasureTheory.MeasureSpace.volume.{0} Real Real.measureSpace))
  (normalized :
    @Eq.{1} Real
      (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
        (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
          ...
          (@RCLike.toInnerProductSpaceReal.{0} Real Real.instRCLike))
        (@MeasureTheory.MeasureSpace.toMeasurableSpace.{0} Real Real.measureSpace)
        (@MeasureTheory.MeasureSpace.volume.{0} Real Real.measureSpace) fun (x : Real) => f x)
...
### D013: `NormedAddCommGroup.toSeminormedAddCommGroup`
...
### D016: `RCLike.toInnerProductSpaceReal`
...
### D036: `MeasureTheory.Measure.instFunLike`
...
### D037: `MeasureTheory.Measure.instOuterMeasureClass`
...
### D046: `SeminormedAddGroup.toContinuousENorm`
