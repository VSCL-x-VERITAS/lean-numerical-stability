# Declaration dossier for HDP-02-EX-2.5.5B
      ...
      (∀ (lam : Real),
          And
            ...
            (Real.instLE.le
              ...
              (Real.exp (instHMul.hMul K (instHPow.hPow lam 2))))) →
        ∀ {t : Real},
          Real.instLE.le 0 t → Real.instLT.lt K (instHPow.hPow t 2) → Eq (μ.real (setOf fun ω => GE.ge (abs (X ω)) t)) 0
```
