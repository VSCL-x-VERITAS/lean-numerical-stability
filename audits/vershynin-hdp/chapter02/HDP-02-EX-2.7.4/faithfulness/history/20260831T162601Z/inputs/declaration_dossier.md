...
theorem hdp_02_hex_h2_d7_d4_exact :
    ∃ (mu : Measure Real) (X : Real -> Real) (K3 lam : Real),
      IsProbabilityMeasure mu ∧ Measurable X ∧ 0 < K3 ∧ |lam| <= K3⁻¹ ∧
...
```lean
@Exists.{1} (@MeasureTheory.Measure.{0} Real Real.measurableSpace)
  fun (mu : @MeasureTheory.Measure.{0} Real Real.measurableSpace) =>
  @Exists.{1} (Real → Real) fun (X : Real → Real) =>
    @Exists.{1} Real fun (K3 : Real) =>
...
### D015: `RCLike.toInnerProductSpaceReal`
...
SHA-256: `8072299d359deb4b8076e6971ad16ba83d16de7253b4881e36005324e8ceb074`
