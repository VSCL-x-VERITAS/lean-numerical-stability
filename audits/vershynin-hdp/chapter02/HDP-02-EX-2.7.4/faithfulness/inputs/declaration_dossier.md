# Declaration dossier for HDP-02-EX-2.7.4
...
```lean
have mu := MeasureTheory.Measure.dirac 0;
have X := fun x => 0;
have K3 := 1;
And (MeasureTheory.IsProbabilityMeasure mu)
  (And (Measurable X)
    (And (Real.instLT.lt 0 K3)
      (And
        (∀ (lam : Real),
          Real.instLE.le 0 lam →
            Real.instLE.le lam (Real.instInv.inv K3) →
              Real.instLE.le (MeasureTheory.integral mu fun x => Real.exp (instHMul.hMul lam (abs (X x))))
                (Real.exp (instHMul.hMul K3 lam)))
        (Exists fun lam =>
          And (Real.instLT.lt lam 0)
            (And (Real.instLE.le (abs lam) (Real.instInv.inv K3))
              (Not
                (Real.instLE.le (MeasureTheory.integral mu fun x => Real.exp (instHMul.hMul lam (abs (X x))))
                  (Real.exp (instHMul.hMul K3 lam)))))))))
```
...
```lean
have mu : @MeasureTheory.Measure.{0} Real Real.measurableSpace :=
  @MeasureTheory.Measure.dirac.{0} Real Real.measurableSpace
    (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero));
have X : Real → Real := fun (x : Real) => @OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero);
have K3 : Real := @OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne);
And (@MeasureTheory.IsProbabilityMeasure.{0} Real Real.measurableSpace mu)
  (And (@Measurable.{0, 0} Real Real Real.measurableSpace Real.measurableSpace X)
    (And (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) K3)
      (And
        (∀ (lam : Real),
          @LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) lam →
            @LE.le.{0} Real Real.instLE lam (@Inv.inv.{0} Real Real.instInv K3) →
              @LE.le.{0} Real Real.instLE
                (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
                  (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
                    (@NormedAddCommGroup.toSeminormedAddCommGroup.{0} Real Real.normedAddCommGroup)
                    (@RCLike.toInnerProductSpaceReal.{0} Real Real.instRCLike))
                  Real.measurableSpace mu fun (x : Real) =>
                  Real.exp
                    (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) lam
                      (@abs.{0} Real Real.lattice Real.instAddGroup (X x))))
                (Real.exp (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) K3 lam)))
        (@Exists.{1} Real fun (lam : Real) =>
          And
            (@LT.lt.{0} Real Real.instLT lam
              (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)))
            (And
              (@LE.le.{0} Real Real.instLE (@abs.{0} Real Real.lattice Real.instAddGroup lam)
                (@Inv.inv.{0} Real Real.instInv K3))
              (Not
                (@LE.le.{0} Real Real.instLE
                  (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
                    (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hex_h2_d7_d4`
...
- `NumStability.HDP.ContractSignatures.C_02_hex_h2_d7_d4` imports: `NumStability.HDP.Scalar.SubExponential`
...
### D004: `InnerProductSpace.toNormedSpace`
...
### D011: `MeasureTheory.Measure.dirac`
...
### `NumStability.HDP.ContractSignatures.C_02_hex_h2_d7_d4`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hex_h2_d7_d4.lean`
SHA-256: `3fc20fd5dd90d1ee48befafec2674b289561b4d6394553b8268b7f0b446f4a30`
