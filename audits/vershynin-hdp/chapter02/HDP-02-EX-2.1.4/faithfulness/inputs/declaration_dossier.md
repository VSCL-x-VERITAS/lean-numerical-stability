# Declaration dossier for HDP-02-EX-2.1.4
...
∀ (t : Real),
  Real.instLE.le 1 t →
    And
      (Eq
        (MeasureTheory.integral (NumStability.HDP.Scalar.LimitTheorems.standardNormalLaw.restrict (Set.Ioi t)) fun x =>
          instHPow.hPow x 2)
        (instHAdd.hAdd
          (instHMul.hMul (instHMul.hMul t (Real.instInv.inv (instHMul.hMul 2 Real.pi).sqrt))
            (Real.exp (instHDiv.hDiv (Real.instNeg.neg (instHPow.hPow t 2)) 2)))
          (NumStability.HDP.Scalar.LimitTheorems.standardNormalLaw.real (Set.Ici t))))
      (Real.instLE.le
        (MeasureTheory.integral (NumStability.HDP.Scalar.LimitTheorems.standardNormalLaw.restrict (Set.Ioi t)) fun x =>
          instHPow.hPow x 2)
        (instHMul.hMul
          (instHMul.hMul (instHAdd.hAdd t (instHDiv.hDiv 1 t)) (Real.instInv.inv (instHMul.hMul 2 Real.pi).sqrt))
          (Real.exp (instHDiv.hDiv (Real.instNeg.neg (instHPow.hPow t 2)) 2))))
```
...
```lean
∀ (t : Real)
  (ht : @LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne)) t),
  And
    (@Eq.{1} Real
      (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
        ...
        (@MeasureTheory.Measure.restrict.{0} Real Real.measurableSpace
          NumStability.HDP.Scalar.LimitTheorems.standardNormalLaw (@Set.Ioi.{0} Real Real.instPreorder t))
        fun (x : Real) =>
    ...
    (@LE.le.{0} Real Real.instLE
      ...
      (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
        (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
          (@HAdd.hAdd.{0, 0, 0} Real Real Real (@instHAdd.{0} Real Real.instAdd) t
            (@HDiv.hDiv.{0, 0, 0} Real Real Real
              (@instHDiv.{0} Real (@DivInvMonoid.toDiv.{0} Real Real.instDivInvMonoid))
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hex_h2_d1_d4`, `NumStability.HDP.Scalar.GaussianTails`
...
- `NumStability.HDP.ContractSignatures.C_02_hex_h2_d1_d4` imports: `NumStability.HDP.Scalar.LimitTheorems`
...
### D013: `MeasureTheory.Measure.restrict`
...
### D023: `RCLike.toInnerProductSpaceReal`
...
### D051: `ProbabilityTheory.gaussianReal`
...
### `NumStability.HDP.ContractSignatures.C_02_hex_h2_d1_d4`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hex_h2_d1_d4.lean`
SHA-256: `ba804293ef1df1f18e35c1a3a662190861bc6c1f12fc6c982a802d27802f4580`
