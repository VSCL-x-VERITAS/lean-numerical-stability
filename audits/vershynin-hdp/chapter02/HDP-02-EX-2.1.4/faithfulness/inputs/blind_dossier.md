...
∀ (t : Real),
  Real.instLE.le 1 t →
    And
      (Eq
        (MeasureTheory.integral (LocalDef001.restrict (Set.Ioi t)) fun x =>
          instHPow.hPow x 2)
        (instHAdd.hAdd
    ...
    (@Eq.{1} Real
      (@MeasureTheory.integral.{0, 0} Real Real Real.normedAddCommGroup
        ...
        (@MeasureTheory.Measure.restrict.{0} Real Real.measurableSpace
          LocalDef001 (@Set.Ioi.{0} Real Real.instPreorder t))
        fun (x : Real) =>
      ...
      (@HAdd.hAdd.{0, 0, 0} Real Real Real (@instHAdd.{0} Real Real.instAdd)
        ...
        (@MeasureTheory.Measure.real.{0} Real Real.measurableSpace
          LocalDef001 (@Set.Ici.{0} Real Real.instPreorder t))))
