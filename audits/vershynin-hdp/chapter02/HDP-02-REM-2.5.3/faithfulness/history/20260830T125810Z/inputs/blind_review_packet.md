...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  Real.instLT.lt 1 A →
    And
      (Iff
        (Exists fun K =>
          And (Real.instLT.lt 0 K) (LocalDef002 μ X K 2))
        (Exists fun K =>
          And (Real.instLT.lt 0 K) (LocalDef002 μ X K A)))
      (Iff
        (Exists fun K =>
          And (Real.instLT.lt 0 K) (LocalDef001 μ X K 2))
        (Exists fun K =>
          And (Real.instLT.lt 0 K) (LocalDef001 μ X K A)))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  And
    (Iff
      ...
      (@Exists.{1} Real fun (K : Real) =>
        And (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) K)
          (@LocalDef002.{u_1} Ω inst μ X K A)))
    (Iff
      (@Exists.{1} Real fun (K : Real) =>
        And (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) K)
          (@LocalDef001.{u_1} Ω inst μ X K
            (@OfNat.ofNat.{0} Real (nat_lit 2)
              (@instOfNatAtLeastTwo.{0} Real (nat_lit 2) Real.instNatCast
                (@Nat.instAtLeastTwoHAddOfNat (@OfNat.ofNat.{0} Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))
                  (@Nat.instNeZeroSucc (@OfNat.ofNat.{0} Nat (nat_lit 0) (instOfNatNat (nat_lit 0)))))))))
      (@Exists.{1} Real fun (K : Real) =>
        And (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) K)
          (@LocalDef001.{u_1} Ω inst μ X K A)))
```
