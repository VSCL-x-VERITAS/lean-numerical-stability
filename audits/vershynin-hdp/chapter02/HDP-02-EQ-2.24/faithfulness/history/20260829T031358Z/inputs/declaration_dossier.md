# Declaration dossier for HDP-02-EQ-2.24
              ...
              ∀ {lam : Real},
                ...
                Real.instLT.lt 0 K →
                  Real.instLE.le (abs lam) (instHDiv.hDiv c K) →
                    ∀ (i : ι), MeasureTheory.Integrable (fun ω => Real.exp (instHMul.hMul lam (X i ω))) μ)
```
...
### D035: `RCLike.toInnerProductSpaceReal`
...
### D061: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D062: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D063: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D064: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D065: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D066: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D067: `ENNReal.instCompleteLinearOrder`
