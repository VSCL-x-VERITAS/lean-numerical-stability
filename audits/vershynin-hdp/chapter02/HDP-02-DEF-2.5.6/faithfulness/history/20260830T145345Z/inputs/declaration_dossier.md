# Declaration dossier for HDP-02-DEF-2.5.6
    ...
    And
      (∀ (i : NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind),
        Ne i NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.linearMGF →
          Iff (NumStability.HDP.Scalar.SubGaussian.IsSubGaussian μ X)
            (Exists fun K =>
              And (Real.instLT.lt 0 K) (NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty μ X i K)))
      (NumStability.HDP.Scalar.SubGaussian.IsSubGaussian μ X →
        And (ENNReal.instPartialOrder.lt (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm μ X) instTopENNReal.top)
          (Eq (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm μ X)
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  (_hX : @Measurable.{u_1, 0} Ω Real inst Real.measurableSpace X),
  And
    (∀ (i : NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind),
      @Ne.{1} NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind i
        ...
        Iff (@NumStability.HDP.Scalar.SubGaussian.IsSubGaussian.{u_1} Ω inst μ X)
          (@Exists.{1} Real fun (K : Real) =>
            And
              (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))
                K)
              (@NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty.{u_1} Ω inst μ X i K)))
    (@NumStability.HDP.Scalar.SubGaussian.IsSubGaussian.{u_1} Ω inst μ X →
      And
        (@LT.lt.{0} ENNReal (@Preorder.toLT.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
          (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_1} Ω inst μ X) (@Top.top.{0} ENNReal instTopENNReal))
        (@Eq.{1} ENNReal (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_1} Ω inst μ X)
          (@InfSet.sInf.{0} ENNReal
            ...
            (@setOf.{0} ENNReal fun (t : ENNReal) =>
              @NumStability.HDP.Scalar.SubGaussian.PsiTwoAdmissible.{u_1} Ω inst μ X t))))
```
...
### D001: `NumStability.HDP.Scalar.SubGaussian.IsSubGaussian`

- Role: `local`
- Owner module: `AuditTarget`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `deccdf24fade77d67fdea63ac2a4d11c28c7db13b8d8b812daba16a2f679b90b`
...
### D003: `NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm`

- Role: `local`
- Owner module: `AuditTarget`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `00ff40f3e85d86d116aa75e86519ee3ec9fac76379eec1725d7a7d598d630f12`
...
### D004: `NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty`

- Role: `local`
- Owner module: `AuditTarget`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `f1680e097df635c6e6ffd6b2c07ccc4f4105e7f44b8a35b0419511bb6b3dc74f`
...
### D005: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind`
...
### D006: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.linearMGF`
...
### D009: `NumStability.HDP.Scalar.SubGaussian.SubGaussianLinearMGF`
...
### D010: `NumStability.HDP.Scalar.SubGaussian.SubGaussianMomentBound`
...
### D011: `NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty.match_1`
...
### D012: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.moment`
...
### D013: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.squarePoint`
...
### D014: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.squareWindow`
...
### D015: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.tail`
...
### D016: `NumStability.HDP.Scalar.SubGaussian.SubGaussianSquarePoint`

- Role: `local`
- Owner module: `AuditTarget`
- Declaration kind: `def`
- Distance from target type: `2`
- Semantic SHA-256: `5c9b471fbe8c671639373c52cf4592706d40ac7a19f9ebf758aadb459f08a9c4`
...
### D017: `NumStability.HDP.Scalar.SubGaussian.SubGaussianSquareWindow`
...
### D018: `NumStability.HDP.Scalar.SubGaussian.SubGaussianTailBound`

- Role: `local`
- Owner module: `AuditTarget`
- Declaration kind: `def`
- Distance from target type: `2`
- Semantic SHA-256: `8f710df757e1d589893a5a3ae9a329d7ab9774338fd9bbe9b08a2cd49f66e3cd`
...
### D019: `NumStability.HDP.Scalar.SubGaussian.LpMomentGrowth`
...
### D020: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.casesOn`
...
### D021: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.rec`
...
### D023: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D024: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D025: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D026: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D027: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D028: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D030: `ENNReal.instCompleteLinearOrder`
...
### D039: `MeasureTheory.IsProbabilityMeasure`
...
### D057: `InnerProductSpace.toNormedSpace`
...
### D063: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D064: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D066: `NormedCommRing.toSeminormedCommRing`
...
### D067: `PseudoMetricSpace.toUniformSpace`
...
### D068: `RCLike.toInnerProductSpaceReal`
...
### D078: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D079: `SeminormedAddGroup.toContinuousENorm`
...
### D080: `SeminormedCommRing.toNonUnitalSeminormedCommRing`
...
### D081: `UniformSpace.toTopologicalSpace`
...
### D092: `MeasureTheory.Measure.real`
