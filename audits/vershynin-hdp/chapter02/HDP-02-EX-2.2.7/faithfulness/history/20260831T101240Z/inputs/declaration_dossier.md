# Declaration dossier for HDP-02-EX-2.2.7
      ...
      (∀ (i : ι),
        ...
        Real.instLT.lt 0 t →
          Real.instLE.le
            ...
            (Real.exp
              (instHDiv.hDiv (instHMul.hMul (-2) (instHPow.hPow t 2))
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
  ...
  {m M : ι → Real} {t : Real} (hX : ∀ (i : ι), @Measurable.{u_2, 0} Ω Real inst_1 Real.measurableSpace (X i))
  (hIndep :
      ...
      @Filter.Eventually.{u_2} Ω
        (fun (ω : Ω) =>
          @Membership.mem.{0, 0} Real (Set.{0} Real) (@Set.instMembership.{0} Real)
            (@Set.Icc.{0} Real Real.instPreorder (m i) (M i)) (X i ω))
        ...
        (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
          @HPow.hPow.{0, 0, 0} Real Nat Real (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid))
            (@Norm.norm.{0} Real Real.norm
              (@HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub) (M i) (m i)))
            (@OfNat.ofNat.{0} Nat (nat_lit 2) (instOfNatNat (nat_lit 2))))))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.Contracts.C_02_hthm_h2_d2_d6`
...
- `NumStability.HDP.Contracts.C_02_hthm_h2_d2_d6` imports: `NumStability.HDP.Scalar.IndependentSums.Hoeffding`
...
### D018: `MeasureTheory.Measure.instFunLike`
...
### D019: `MeasureTheory.Measure.instOuterMeasureClass`
...
### D020: `MeasureTheory.Measure.real`
...
### `NumStability.HDP.Contracts.C_02_hthm_h2_d2_d6`

Path: `lean-numerical-stability/NumStability/HDP/Contracts/C_02_hthm_h2_d2_d6.lean`
SHA-256: `d2579abd7ac5257917ee6680255f5406ffa0f36cf94d88b5a91bcdad0bd6b6b8`
