...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  ...
  Exists fun c =>
    And (Real.instLT.lt 0 c)
      (∀ {X : ι → Ω → Real} {a : ι → Real} (hne : Finset.univ.Nonempty),
        (∀ (i : ι), Measurable (X i)) →
                                  ...
                                  (Real.instMin.min
                                    ...
                                    (instHDiv.hDiv t
                                      (instHMul.hMul
                                        (Finset.univ.sup' hne fun i =>
                                          (NumStability.HDP.Scalar.SubExponential.PsiOneGauge μ (X i)).toReal)
                                        (Finset.univ.sup' hne fun i => abs (a i))))))))))
```
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
  ...
  @Exists.{1} Real fun (c : Real) =>
    And (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) c)
      (∀ {X : ι → Ω → Real} {a : ι → Real} (hne : @Finset.Nonempty.{u_1} ι (@Finset.univ.{u_1} ι inst)),
                  ...
                  @LT.lt.{0} Real Real.instLT
                      ...
                      (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
                        @HPow.hPow.{0, 0, 0} Real Nat Real
                          (@instHPow.{0, 0} Real Nat (@Monoid.toNatPow.{0} Real Real.instMonoid)) (a i)
                                  ...
                                  (@Min.min.{0} Real Real.instMin
                                    ...
                                    (@HDiv.hDiv.{0, 0, 0} Real Real Real
                                      ...
                                      (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
                                        ...
                                        (@Finset.sup'.{0, u_1} Real ι Real.instSemilatticeSup
                                          (@Finset.univ.{u_1} ι inst) hne fun (i : ι) =>
                                          @abs.{0} Real Real.lattice Real.instAddGroup (a i))))))))))
```
