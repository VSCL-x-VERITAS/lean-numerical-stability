        ...
        ∀ {t : ℝ}, 0 ≤ t →
          μ.real {ω | |∑ i, a i * X i ω| ≥ t} ≤
            2 * Real.exp (-(c * min (t ^ 2 / ∑ i, (a i * K i) ^ 2)
              (t / Finset.univ.sup' hne (fun i => |a i| * K i))))
```
...
Exists fun c =>
  And (Real.instLT.lt 0 c)
    (∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
      [MeasureTheory.IsProbabilityMeasure μ] {X : ι → Ω → Real} {K a : ι → Real} (hne : Finset.univ.Nonempty),
                      ...
                      (Real.instNeg.neg
                        (instHMul.hMul c
                          (Real.instMin.min
                            ...
                            (instHDiv.hDiv t (Finset.univ.sup' hne fun i => instHMul.hMul (abs (a i)) (K i)))))))))
```
...
@Exists.{1} Real fun (c : Real) =>
  And (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) c)
    (∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
      ...
      {X : ι → Ω → Real} {K a : ι → Real} (hne : @Finset.Nonempty.{u_1} ι (@Finset.univ.{u_1} ι inst)),
      (∀ (i : ι),
