# Declaration dossier for HDP-02-EQ-2.6
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  [MeasureTheory.IsProbabilityMeasure μ] {X : ι → Ω → Real} (lam : Real) (a : ι → Real),
  ProbabilityTheory.iIndepFun X μ →
    (∀ (i : ι), MeasureTheory.Integrable (fun ω => Real.exp (instHMul.hMul lam (instHMul.hMul (a i) (X i ω)))) μ) →
      Eq
        (MeasureTheory.integral μ fun ω =>
          Real.exp (instHMul.hMul lam (Finset.univ.sum fun i => instHMul.hMul (a i) (X i ω))))
        (Finset.univ.prod fun i =>
          MeasureTheory.integral μ fun ω => Real.exp (instHMul.hMul lam (instHMul.hMul (a i) (X i ω))))
```
...
### D017: `ProbabilityTheory.iIndepFun`
