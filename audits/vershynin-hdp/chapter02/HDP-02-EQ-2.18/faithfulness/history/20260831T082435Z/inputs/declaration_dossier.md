# Declaration dossier for HDP-02-EQ-2.18
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  [MeasureTheory.IsProbabilityMeasure μ] {X : ι → Ω → Real} {σ : ι → NNReal} (a : ι → Real),
  (∀ (i : ι), ProbabilityTheory.HasLaw (X i) (ProbabilityTheory.gaussianReal 0 (σ i)) μ) →
    ProbabilityTheory.iIndepFun X μ →
      ProbabilityTheory.HasLaw (fun ω => Finset.univ.sum fun i => instHMul.hMul (a i) (X i ω))
        (ProbabilityTheory.gaussianReal 0
          (Finset.univ.sum fun i => instHMul.hMul (instHPow.hPow (a i) 2).toNNReal (σ i)))
        μ
```
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
  ...
  (hLaw :
    ∀ (i : ι),
      @ProbabilityTheory.HasLaw.{u_2, 0} Ω Real inst_1 Real.measurableSpace (X i)
  ...
  (hIndep :
    @ProbabilityTheory.iIndepFun.{u_2, u_1, 0} Ω ι inst_1 (fun (x : ι) => Real) (fun (x : ι) => Real.measurableSpace) X
      μ),
  @ProbabilityTheory.HasLaw.{u_2, 0} Ω Real inst_1 Real.measurableSpace
    (fun (ω : Ω) =>
    ...
    (ProbabilityTheory.gaussianReal (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))
      (@Finset.sum.{u_1, 0} ι NNReal
        (@NonUnitalNonAssocSemiring.toAddCommMonoid.{0} NNReal
...
### D013: `NonAssocSemiring.toNonUnitalNonAssocSemiring`
...
### D014: `NonUnitalNonAssocSemiring.toAddCommMonoid`
...
### D015: `NonUnitalNonAssocSemiring.toDistrib`
...
### D018: `ProbabilityTheory.gaussianReal`
...
### D019: `ProbabilityTheory.iIndepFun`
