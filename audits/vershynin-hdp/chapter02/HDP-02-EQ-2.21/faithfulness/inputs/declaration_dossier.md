# Declaration dossier for HDP-02-EQ-2.21
...
∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] (mu : MeasureTheory.Measure Omega) (X : Omega → Real),
  Eq (NumStability.HDP.Scalar.SubExponential.PsiOneGauge mu X)
    (ConditionallyCompleteLattice.toConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf.sInf
      (setOf fun t => NumStability.HDP.Scalar.SubExponential.PsiOneAdmissible mu X t))
```
...
∀ {Omega : Type u_1} [inst : MeasurableSpace.{u_1} Omega] (mu : @MeasureTheory.Measure.{u_1} Omega inst)
  (X : Omega → Real),
  @Eq.{1} ENNReal (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_1} Omega inst mu X)
    (@InfSet.sInf.{0} ENNReal
      ...
      (@setOf.{0} ENNReal fun (t : ENNReal) =>
        @NumStability.HDP.Scalar.SubExponential.PsiOneAdmissible.{u_1} Omega inst mu X t))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_heq_h2_d21`
...
- `NumStability.HDP.ContractSignatures.C_02_heq_h2_d21` imports: `NumStability.HDP.Scalar.SubExponential`

## Semantic dependency inventory

`local` declarations are followed recursively through types and bodies. `external-frontier` declarations mark the one-level library trust boundary.

### D001: `NumStability.HDP.Scalar.SubExponential.PsiOneAdmissible`
...
### `NumStability.HDP.ContractSignatures.C_02_heq_h2_d21`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_heq_h2_d21.lean`
SHA-256: `b500aee2ebac17b90127050f6656fba9e309d39fd416acb94c8036ef0c5c4a5a`
