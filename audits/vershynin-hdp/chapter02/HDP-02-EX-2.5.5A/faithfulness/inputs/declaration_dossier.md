# Declaration dossier for HDP-02-EX-2.5.5A
...
∀ (lam : Real),
  And
    (Real.instLT.lt (abs lam) (Real.instInv.inv (Real.sqrt 2)) →
      And
        (MeasureTheory.Integrable (fun x => Real.exp (instHMul.hMul (instHPow.hPow lam 2) (instHPow.hPow x 2)))
          (ProbabilityTheory.gaussianReal 0 1))
        (Eq
          (MeasureTheory.integral (ProbabilityTheory.gaussianReal 0 1) fun x =>
            Real.exp (instHMul.hMul (instHPow.hPow lam 2) (instHPow.hPow x 2)))
          (Real.instInv.inv (instHSub.hSub 1 (instHMul.hMul 2 (instHPow.hPow lam 2))).sqrt)))
    (Real.instLE.le (Real.instInv.inv (Real.sqrt 2)) (abs lam) →
      Not
        (MeasureTheory.Integrable (fun x => Real.exp (instHMul.hMul (instHPow.hPow lam 2) (instHPow.hPow x 2)))
          (ProbabilityTheory.gaussianReal 0 1)))
```
...
∀ (lam : Real),
  And
    (@LT.lt.{0} Real Real.instLT (@abs.{0} Real Real.lattice Real.instAddGroup lam)
          ...
          (Real.sqrt
            (@OfNat.ofNat.{0} Real (nat_lit 2)
              (@instOfNatAtLeastTwo.{0} Real (nat_lit 2) Real.instNatCast
                (@Nat.instAtLeastTwoHAddOfNat (@OfNat.ofNat.{0} Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))
                  (@Nat.instNeZeroSucc (@OfNat.ofNat.{0} Nat (nat_lit 0) (instOfNatNat (nat_lit 0)))))))))
        (@abs.{0} Real Real.lattice Real.instAddGroup lam) →
      Not
        (@MeasureTheory.Integrable.{0, 0} Real
          (@UniformSpace.toTopologicalSpace.{0} Real
            (@PseudoMetricSpace.toUniformSpace.{0} Real Real.pseudoMetricSpace))
