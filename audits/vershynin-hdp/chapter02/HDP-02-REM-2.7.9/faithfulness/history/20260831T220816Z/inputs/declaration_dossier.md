...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hrem_h2_d7_d9`, `NumStability.HDP.Scalar.MGFLocalTaylor`, `NumStability.HDP.Scalar.SubExponential`
...
- Semantic SHA-256: `a9eae30c90961afe25f33b4417c744bb7debb3b70900ad83d1d700946c441821`
...
And
  ...
  (And
    ...
    (And
      (∀ (lam : Real),
        Real.instLT.lt lam 1 →
          And (MeasureTheory.Integrable (fun x => Real.exp (instHMul.hMul lam x)) (ProbabilityTheory.expMeasure 1))
            (Eq (MeasureTheory.integral (ProbabilityTheory.expMeasure 1) fun x => Real.exp (instHMul.hMul lam x))
              (Real.instInv.inv (instHSub.hSub 1 lam))))
      (∀ (lam : Real),
        Real.instLE.le 1 lam →
          Not (MeasureTheory.Integrable (fun x => Real.exp (instHMul.hMul lam x)) (ProbabilityTheory.expMeasure 1)))))
```

### D002: `NumStability.HDP.Contract.hdp_02_hrem_h2_d7_d9_exact__contract_type._proof_1`

- Role: `local`
- Owner module: `NumStability.HDP.ContractSignatures.C_02_hrem_h2_d7_d9`
- Declaration kind: `theorem`
- Distance from target type: `2`
- Semantic SHA-256: `af33ede62b24de40a63b168fd62565c77fe8417fa713f397c1cae50324b92c0e`
...
### D032: `ProbabilityTheory.expMeasure`
