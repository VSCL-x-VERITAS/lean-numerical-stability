# Declaration dossier for HDP-02-BODY-2.2-TWO-SIDED-SPLIT
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  Measurable S →
    ∀ {t : Real},
      Real.instLT.lt 0 t →
        Eq (μ.real (setOf fun ω => GE.ge (abs (S ω)) t))
          (instHAdd.hAdd (μ.real (setOf fun ω => GE.ge (S ω) t))
            (μ.real (setOf fun ω => GE.ge (Real.instNeg.neg (S ω)) t)))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  (hS : @Measurable.{u_1, 0} Ω Real inst Real.measurableSpace S) {t : Real}
  ...
  @Eq.{1} Real
    (@MeasureTheory.Measure.real.{u_1} Ω inst μ
      (@setOf.{u_1} Ω fun (ω : Ω) =>
        @GE.ge.{0} Real Real.instLE (@abs.{0} Real Real.lattice Real.instAddGroup (S ω)) t))
    (@HAdd.hAdd.{0, 0, 0} Real Real Real (@instHAdd.{0} Real Real.instAdd)
      (@MeasureTheory.Measure.real.{u_1} Ω inst μ (@setOf.{u_1} Ω fun (ω : Ω) => @GE.ge.{0} Real Real.instLE (S ω) t))
      (@MeasureTheory.Measure.real.{u_1} Ω inst μ
        (@setOf.{u_1} Ω fun (ω : Ω) => @GE.ge.{0} Real Real.instLE (@Neg.neg.{0} Real Real.instNeg (S ω)) t)))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.Scalar.IndependentSums.TwoSidedTail`
...
- `NumStability.HDP.Scalar.IndependentSums.TwoSidedTail` imports: `NumStability.HDP.Scalar.Preliminaries`
...
### `NumStability.HDP.Scalar.IndependentSums.TwoSidedTail`

Path: `lean-numerical-stability/NumStability/HDP/Scalar/IndependentSums/TwoSidedTail.lean`
SHA-256: `27f23fff830d39d3a3a73703d7a0e2e4d86dd351ab2bb8661fec8299f6b10a24`
