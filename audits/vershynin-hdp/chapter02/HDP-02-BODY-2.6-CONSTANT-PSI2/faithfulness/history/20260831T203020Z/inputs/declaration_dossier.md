# Declaration dossier for HDP-02-BODY-2.6-CONSTANT-PSI2
...
Exists fun C =>
  And (Real.instLE.le 1 C)
    (∀ {Omega : Type u_1} [inst : MeasurableSpace Omega] {mu : MeasureTheory.Measure Omega}
      [MeasureTheory.IsProbabilityMeasure mu] (a : Real),
      ENNReal.instPartialOrder.le (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm mu fun x => a)
        (ENNReal.ofReal (instHMul.hMul C (abs a))))
```
...
@Exists.{1} Real fun (C : Real) =>
  And (@LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne)) C)
    (∀ {Omega : Type u_1} [inst : MeasurableSpace.{u_1} Omega] {mu : @MeasureTheory.Measure.{u_1} Omega inst}
      [@MeasureTheory.IsProbabilityMeasure.{u_1} Omega inst mu] (a : Real),
      @LE.le.{0} ENNReal (@Preorder.toLE.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
        (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_1} Omega inst mu fun (x : Omega) => a)
        (ENNReal.ofReal
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hbody_h2_d6_hconstant_hpsi2`, `NumStability.HDP.Scalar.SubGaussianCentering`
...
- `NumStability.HDP.ContractSignatures.C_02_hbody_h2_d6_hconstant_hpsi2` imports: `NumStability.HDP.Scalar.SubGaussian`
...
### D001: `NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm`
...
### D027: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D028: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D029: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D030: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D031: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D032: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D033: `ENNReal.instCompleteLinearOrder`
...
### D040: `InnerProductSpace.toNormedSpace`
...
### D049: `NormedAddCommGroup.toSeminormedAddCommGroup`
...
### D051: `PseudoMetricSpace.toUniformSpace`
...
### D052: `RCLike.toInnerProductSpaceReal`
...
### D062: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D063: `SeminormedAddGroup.toContinuousENorm`
...
### `NumStability.HDP.ContractSignatures.C_02_hbody_h2_d6_hconstant_hpsi2`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hbody_h2_d6_hconstant_hpsi2.lean`
SHA-256: `4fde1d168d7de8e3a7b9475bfbebcaffb969e62982d5af736b3dd300b0f05ab9`
