...
∀ (t : Real),
  Real.instLT.lt 0 t →
    And
      (Eq (LocalDef001.real (setOf fun x => GT.gt (instHPow.hPow x 2) t))
        (LocalDef001.real (setOf fun x => GT.gt (abs x) t.sqrt)))
      (And
        (Real.instLE.le
          ...
          (LocalDef001.real (setOf fun x => GT.gt (instHPow.hPow x 2) t)))
        (Real.instLE.le
          (LocalDef001.real (setOf fun x => GT.gt (instHPow.hPow x 2) t))
          (instHMul.hMul (instHMul.hMul 2 (Real.instInv.inv (instHMul.hMul 2 Real.pi).sqrt))
