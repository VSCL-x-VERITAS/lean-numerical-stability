...
Exists fun C =>
  And (Real.instLE.le 1 C)
    (∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
      ...
      NumStability.HDP.Scalar.SubGaussian.IsSubGaussian μ X →
        And
          (NumStability.HDP.Scalar.SubGaussian.IsSubGaussian μ fun ω =>
            instHSub.hSub (X ω) (MeasureTheory.integral μ fun x => X x))
          (ENNReal.instPartialOrder.le
            (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm μ fun ω =>
              instHSub.hSub (X ω) (MeasureTheory.integral μ fun x => X x))
            (instHMul.hMul (ENNReal.ofReal C) (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm μ X))))
```
  ...
  And (@LE.le.{0} Real Real.instLE (@OfNat.ofNat.{0} Real (nat_lit 1) (@One.toOfNat1.{0} Real Real.instOne)) C)
    (∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
      ...
      @NumStability.HDP.Scalar.SubGaussian.IsSubGaussian.{u_1} Ω inst μ X →
        And
          (@NumStability.HDP.Scalar.SubGaussian.IsSubGaussian.{u_1} Ω inst μ fun (ω : Ω) =>
          ...
          (@LE.le.{0} ENNReal
            ...
            (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_1} Ω inst μ fun (ω : Ω) =>
              @HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub) (X ω)
                (@MeasureTheory.integral.{u_1, 0} Ω Real Real.normedAddCommGroup
                  (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
                    (@NormedAddCommGroup.toSeminormedAddCommGroup.{0} Real Real.normedAddCommGroup)
            ...
            (@HMul.hMul.{0, 0, 0} ENNReal ENNReal ENNReal
              ...
              (ENNReal.ofReal C) (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_1} Ω inst μ X))))
```

## Local import graph

- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d6_d8`, `NumStability.HDP.Scalar.SubGaussianCentering`
...
- `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d6_d8` imports: `NumStability.HDP.Scalar.SubGaussian`
- `NumStability.HDP.Scalar.SubGaussianCentering` imports: `NumStability.HDP.Scalar.SubGaussian`
...
- Semantic SHA-256: `dd1703865efea6928ea5a164ef0701359581e5167ee20bdfb2e5ed5ad94087ad`
...
### D002: `NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm`

- Role: `local`
- Owner module: `NumStability.HDP.Scalar.SubGaussian`
- Declaration kind: `def`
- Distance from target type: `1`
- Semantic SHA-256: `062071118954839b72c813150b528997d54b6ce3b76cc90872f87a644d8cf80d`
...
### D003: `NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge`
...
### D004: `NumStability.HDP.Scalar.SubGaussian.SubGaussianSquarePoint`
...
### D005: `NumStability.HDP.Scalar.SubGaussian.EvenMomentBound._proof_1`
...
### D006: `NumStability.HDP.Scalar.SubGaussian.PsiTwoAdmissible`
...
### D037: `Semiring.toNonAssocSemiring`
...
### D046: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D047: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D048: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D049: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D050: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D051: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D062: `NormedCommRing.toSeminormedCommRing`
...
### D063: `PseudoMetricSpace.toUniformSpace`
...
### `NumStability.HDP.ContractSignatures.C_02_hlem_h2_d6_d8`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_hlem_h2_d6_d8.lean`
SHA-256: `262b5c1f55165fd9acaaf2279e5508018d4d99595adf1fa5218263dac704430a`
...
### `NumStability.HDP.Scalar.SubGaussianCentering`

Path: `lean-numerical-stability/NumStability/HDP/Scalar/SubGaussianCentering.lean`
SHA-256: `2ecfb8fc0e6bef83a04c851537d6cbf804315286bbf3a1a482cf3d50e4a9c35c`
