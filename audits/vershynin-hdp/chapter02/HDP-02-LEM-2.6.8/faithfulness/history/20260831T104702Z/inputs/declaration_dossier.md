# Declaration dossier for HDP-02-LEM-2.6.8
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  {X : Ω → Real} (i : NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind) {K : Real},
  Real.instLT.lt 0 K →
          ...
          (And (MeasureTheory.Integrable X μ)
            (Exists fun K' =>
              And (Real.instLT.lt 0 K')
                (And (Real.instLE.le K' (instHMul.hMul C K))
                  (And
                    (NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty μ
                      (fun ω => instHSub.hSub (X ω) (MeasureTheory.integral μ fun x => X x))
                      NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.squarePoint K')
                    (ENNReal.instPartialOrder.le
                      (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge μ fun ω =>
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  (i : NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind) {K : Real}
  (hK : @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) K)
  (hProp : @NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty.{u_1} Ω inst μ X i K),
      ...
      (And
        ...
        (@Exists.{1} Real fun (K' : Real) =>
          And
            ...
            (And
              (@LE.le.{0} Real Real.instLE K'
                (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) C K))
              (And
                (@NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty.{u_1} Ω inst μ
                  (fun (ω : Ω) =>
                ...
                (@LE.le.{0} ENNReal
                  ...
                  (@NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge.{u_1} Ω inst μ fun (ω : Ω) =>
                    @HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub) (X ω)
                      (@MeasureTheory.integral.{u_1, 0} Ω Real Real.normedAddCommGroup
                        (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
                          (@NormedAddCommGroup.toSeminormedAddCommGroup.{0} Real Real.normedAddCommGroup)
...
### D002: `NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty`
...
### D003: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind`
...
### D004: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.squarePoint`
...
### D005: `NumStability.HDP.Scalar.SubGaussian.PsiTwoAdmissible`
...
### D006: `NumStability.HDP.Scalar.SubGaussian.SubGaussianLinearMGF`
...
### D007: `NumStability.HDP.Scalar.SubGaussian.SubGaussianMomentBound`
...
### D008: `NumStability.HDP.Scalar.SubGaussian.SubGaussianProperty.match_1`
...
### D009: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.linearMGF`
...
### D010: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.moment`
...
### D011: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.squareWindow`
...
### D012: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.tail`
...
### D013: `NumStability.HDP.Scalar.SubGaussian.SubGaussianSquarePoint`
...
### D014: `NumStability.HDP.Scalar.SubGaussian.SubGaussianSquareWindow`
...
### D015: `NumStability.HDP.Scalar.SubGaussian.SubGaussianTailBound`
...
### D017: `NumStability.HDP.Scalar.SubGaussian.LpMomentGrowth`
...
### D018: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.casesOn`
...
### D019: `NumStability.HDP.Scalar.SubGaussian.SubGaussianPropertyKind.rec`
...
### D037: `NormedAddCommGroup.toSeminormedAddCommGroup`
...
### D056: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D057: `SeminormedAddGroup.toContinuousENorm`
...
### D063: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D064: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D065: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D066: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D067: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D068: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D069: `ENNReal.instCompleteLinearOrder`
...
### D081: `MeasureTheory.Measure.real`
