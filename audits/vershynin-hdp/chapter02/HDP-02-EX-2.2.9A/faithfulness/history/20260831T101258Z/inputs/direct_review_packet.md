# Declaration dossier for HDP-02-EX-2.2.9A
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  (N : Nat) (hN : instLTNat.lt 0 N) {X : Fin N → Ω → Real},
    ...
    (∀ (i : Fin N), MeasureTheory.MemLp (X i) 2 μ) →
      Pairwise (Function.onFun (fun x1 x2 => ProbabilityTheory.IndepFun x1 x2 μ) X) →
        (∀ (i : Fin N), ProbabilityTheory.IdentDistrib (X i) (X ⟨0, hN⟩) μ μ) →
          ∀ {σ ε : Real},
            Eq (ProbabilityTheory.variance (X ⟨0, hN⟩) μ) (instHPow.hPow σ 2) →
              Real.instLT.lt 0 ε →
                  ...
                  Real.instLE.le
                    (μ.real
                      (setOf fun ω =>
                        GE.ge
                          (abs
                            (instHSub.hSub (instHMul.hMul (Real.instInv.inv N.cast) (Finset.univ.sum fun i => X i ω))
                              (MeasureTheory.integral μ fun y => X ⟨0, hN⟩ y)))
                          ε))
                    (1 / 4)
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  (hMeas : ∀ (i : Fin N), @Measurable.{u_1, 0} Ω Real inst Real.measurableSpace (X i))
  (hX :
    ∀ (i : Fin N),
          ...
          (@abs.{0} Real Real.lattice Real.instAddGroup
            (@HSub.hSub.{0, 0, 0} Real Real Real (@instHSub.{0} Real Real.instSub)
              ...
              (@MeasureTheory.integral.{u_1, 0} Ω Real Real.normedAddCommGroup
                ...
                inst μ fun (y : Ω) =>
                X (@Fin.mk N (@OfNat.ofNat.{0} Nat (nat_lit 0) (instOfNatNat (nat_lit 0))) hN) y)))
          ε))
    (@HDiv.hDiv.{0, 0, 0} Real Real Real (@instHDiv.{0} Real (@DivInvMonoid.toDiv.{0} Real Real.instDivInvMonoid))
...
- `AuditTarget` imports: `NumStability.HDP.Scalar.IndependentSums.SampleMeanChebyshev`
...
### D032: `Nat.instAtLeastTwoHAddOfNat`
...
### D041: `ProbabilityTheory.IdentDistrib`
...
### D042: `ProbabilityTheory.IndepFun`
...
### D043: `ProbabilityTheory.variance`
...
### D065: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D066: `SeminormedAddGroup.toContinuousENorm`
...
### D067: `SeminormedAddGroup.toPseudoMetricSpace`
