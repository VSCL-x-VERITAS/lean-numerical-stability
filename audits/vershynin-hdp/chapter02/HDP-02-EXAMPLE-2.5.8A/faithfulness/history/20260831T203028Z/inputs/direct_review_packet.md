  ...
  And (Real.instLT.lt 0 C)
    (And
      (ENNReal.instPartialOrder.le
        (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (ProbabilityTheory.gaussianReal 0 1) id) (ENNReal.ofReal C))
      (∀ (σ : Real),
        Real.instLE.le 0 σ →
          ENNReal.instPartialOrder.le
            (NumStability.HDP.Scalar.SubGaussian.PsiTwoGauge (ProbabilityTheory.gaussianReal 0 ⟨instHPow.hPow σ 2, ⋯⟩)
              id)
            (ENNReal.ofReal (instHMul.hMul C σ))))
```
              ...
              (ProbabilityTheory.gaussianReal
                ...
                (@Subtype.mk.{1} Real
                  ...
                  (@sq_nonneg.{0} Real Real.semiring Real.linearOrder
                    ...
                    σ)))
              (@id.{1} Real))
            (ENNReal.ofReal (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul) C σ))))
```
...
### D011: `IsOrderedAddMonoid.toAddLeftMono`
...
### D012: `IsOrderedRing.toPosMulMono`
...
### D019: `NonUnitalCommRing.toNonUnitalCommSemiring`
...
### D020: `NonUnitalCommSemiring.toNonUnitalSemiring`
...
### D022: `NormedCommRing.toNonUnitalNormedCommRing`
...
### D027: `ProbabilityTheory.gaussianReal`
...
### D030: `Real.instIsOrderedAddMonoid`
...
### D043: `Semiring.toMonoidWithZero`
...
### D044: `StarOrderedRing.toExistsAddOfLE`
...
### D054: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D055: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D056: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D057: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D058: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D059: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D060: `ENNReal.instCompleteLinearOrder`
...
### D068: `InnerProductSpace.toNormedSpace`
...
### D073: `NonUnitalSeminormedCommRing.toNonUnitalSeminormedRing`
...
### D074: `NonUnitalSeminormedRing.toSeminormedAddCommGroup`
...
### D075: `NormedAddCommGroup.toSeminormedAddCommGroup`
...
### D076: `NormedCommRing.toSeminormedCommRing`
...
### D078: `RCLike.toInnerProductSpaceReal`
...
### D086: `SeminormedAddCommGroup.toSeminormedAddGroup`
...
### D087: `SeminormedAddGroup.toContinuousENorm`
...
### D090: `UniformSpace.toTopologicalSpace`
