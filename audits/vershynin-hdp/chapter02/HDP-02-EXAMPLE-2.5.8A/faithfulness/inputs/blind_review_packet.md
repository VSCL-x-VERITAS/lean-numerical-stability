  ...
  And (Real.instLT.lt 0 C)
    (And
      (ENNReal.instPartialOrder.le
        (LocalDef001 (ProbabilityTheory.gaussianReal 0 1) id) (ENNReal.ofReal C))
      (∀ (σ : Real),
        Real.instLE.le 0 σ →
          ENNReal.instPartialOrder.le
            (LocalDef001 (ProbabilityTheory.gaussianReal 0 ⟨instHPow.hPow σ 2, ⋯⟩)
              id)
  ...
  And (@LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero)) C)
    (And
      (@LE.le.{0} ENNReal (@Preorder.toLE.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
        (@LocalDef001.{0} Real Real.measurableSpace
