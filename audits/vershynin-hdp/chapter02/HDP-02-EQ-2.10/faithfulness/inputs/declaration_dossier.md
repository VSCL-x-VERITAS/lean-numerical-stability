# Declaration dossier for HDP-02-EQ-2.10
...
∀ (t : Real),
  Real.instLE.le 0 t →
    Real.instLE.le (NumStability.HDP.Scalar.LimitTheorems.standardNormalLaw.real (setOf fun x => GE.ge (abs x) t))
      (instHMul.hMul 2 (Real.exp (instHDiv.hDiv (Real.instNeg.neg (instHPow.hPow t 2)) 2)))
```
  ...
  @LE.le.{0} Real Real.instLE
    (@MeasureTheory.Measure.real.{0} Real Real.measurableSpace NumStability.HDP.Scalar.LimitTheorems.standardNormalLaw
      (@setOf.{0} Real fun (x : Real) =>
        @GE.ge.{0} Real Real.instLE (@abs.{0} Real Real.lattice Real.instAddGroup x) t))
...
- `AuditTarget` imports: `NumStability.HDP.Scalar.GaussianTails`
