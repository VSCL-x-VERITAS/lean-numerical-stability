# Declaration dossier for HDP-02-COR-2.8.3
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  ...
  Exists fun c =>
    And (Real.instLT.lt 0 c)
      (∀ {X : ι → Ω → Real} (hne : Finset.univ.Nonempty),
        (∀ (i : ι), Measurable (X i)) →
              ...
              ProbabilityTheory.iIndepFun X μ →
                Real.instLT.lt 0
                    (Finset.univ.sup' hne fun i =>
                      (NumStability.HDP.Scalar.SubExponential.PsiOneGauge μ (X i)).toReal) →
                  ∀ {t : Real},
                    Real.instLE.le 0 t →
                      Real.instLE.le
                        (μ.real
            ...
            (∀ (i : ι),
              ...
              @ProbabilityTheory.iIndepFun.{u_2, u_1, 0} Ω ι inst_1 (fun (x : ι) => Real)
                ...
                @LT.lt.{0} Real Real.instLT (@OfNat.ofNat.{0} Real (nat_lit 0) (@Zero.toOfNat0.{0} Real Real.instZero))
                    (@Finset.sup'.{0, u_1} Real ι Real.instSemilatticeSup (@Finset.univ.{u_1} ι inst) hne fun (i : ι) =>
                      ENNReal.toReal (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_2} Ω inst_1 μ (X i))) →
                  ∀ {t : Real},
                                  ...
                                  (@Min.min.{0} Real Real.instMin
                                    (@HDiv.hDiv.{0, 0, 0} Real Real Real
                                      ...
                                      (@HPow.hPow.{0, 0, 0} Real Nat Real
                                        ...
                                        (@Finset.sup'.{0, u_1} Real ι Real.instSemilatticeSup
                                          (@Finset.univ.{u_1} ι inst) hne fun (i : ι) =>
                                          ENNReal.toReal
                                            (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_2} Ω inst_1 μ
                                              (X i)))
                                        (@OfNat.ofNat.{0} Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))))
                                    (@HDiv.hDiv.{0, 0, 0} Real Real Real
                                      (@instHDiv.{0} Real (@DivInvMonoid.toDiv.{0} Real Real.instDivInvMonoid)) t
                                      (@Finset.sup'.{0, u_1} Real ι Real.instSemilatticeSup (@Finset.univ.{u_1} ι inst)
                                        hne fun (i : ι) =>
                                        ENNReal.toReal
                                          (@NumStability.HDP.Scalar.SubExponential.PsiOneGauge.{u_2} Ω inst_1 μ
                                            (X i))))))
...
### D036: `Nat.instAtLeastTwoHAddOfNat`
...
### D084: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D085: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D086: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D087: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D088: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D089: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D090: `ENNReal.instCompleteLinearOrder`
...
SHA-256: `35d7fdece06e05ce9a78d8597e32e7694a259e393e3e5fd0b388f8189f044a93`
