...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype ι] [inst_1 : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω}
  ...
  Real.instLT.lt 0 K →
    (∀ (i : ι), NumStability.HDP.Scalar.IndependentSums.Bernstein.SubExponentialLinearMGF μ (X i) K) →
            ...
            Real.instLE.le 0 t →
              Real.instLE.le
                (μ.real
                  (setOf fun ω =>
                    GE.ge
                      (abs (Finset.univ.sum fun i => instHMul.hMul (Real.instInv.inv (Fintype.card ι).cast) (X i ω)))
                      t))
                (instHMul.hMul 2
                  (Real.exp
                    (Real.instNeg.neg
                      (Real.instMin.min
                        (instHDiv.hDiv (instHPow.hPow t 2)
                          (instHMul.hMul 4
                            (Finset.univ.sum fun _i =>
                              instHPow.hPow (instHMul.hMul (Real.instInv.inv (Fintype.card ι).cast) K) 2)))
                        (instHDiv.hDiv t
                          (instHMul.hMul 2 (instHMul.hMul (Real.instInv.inv (Fintype.card ι).cast) K)))))))
```
...
∀ {ι : Type u_1} {Ω : Type u_2} [inst : Fintype.{u_1} ι] [inst_1 : MeasurableSpace.{u_2} Ω]
  ...
  (hX : ∀ (i : ι), @NumStability.HDP.Scalar.IndependentSums.Bernstein.SubExponentialLinearMGF.{u_2} Ω inst_1 μ (X i) K)
  (hIndep :
          ...
          (@abs.{0} Real Real.lattice Real.instAddGroup
            (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (i : ι) =>
              @HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
                (@Inv.inv.{0} Real Real.instInv (@Nat.cast.{0} Real Real.instNatCast (@Fintype.card.{u_1} ι inst)))
                (X i ω)))
          t))
    (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
          ...
          (@Min.min.{0} Real Real.instMin
            (@HDiv.hDiv.{0, 0, 0} Real Real Real
              ...
              (@HMul.hMul.{0, 0, 0} Real Real Real (@instHMul.{0} Real Real.instMul)
                ...
                (@Finset.sum.{u_1, 0} ι Real Real.instAddCommMonoid (@Finset.univ.{u_1} ι inst) fun (_i : ι) =>
                  @HPow.hPow.{0, 0, 0} Real Nat Real
...
### D026: `ProbabilityTheory.iIndepFun`
...
SHA-256: `94952929196aecac8c9909a1be3e9ad1d21f9957864d990f696a8151cc5b91c1`
