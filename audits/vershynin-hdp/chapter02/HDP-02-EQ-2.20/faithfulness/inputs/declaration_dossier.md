# Declaration dossier for HDP-02-EQ-2.20
...
∀ {Ω : Type u_1} [inst : MeasurableSpace Ω] {μ : MeasureTheory.Measure Ω} [MeasureTheory.IsProbabilityMeasure μ]
  ...
  NumStability.HDP.Scalar.SubGaussian.IsSubGaussian μ X →
    ENNReal.instPartialOrder.le
      ...
      (instHAdd.hAdd (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm μ X)
        (NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm μ fun x => MeasureTheory.integral μ fun x => X x))
```
...
∀ {Ω : Type u_1} [inst : MeasurableSpace.{u_1} Ω] {μ : @MeasureTheory.Measure.{u_1} Ω inst}
  ...
  (_hSub : @NumStability.HDP.Scalar.SubGaussian.IsSubGaussian.{u_1} Ω inst μ X),
  @LE.le.{0} ENNReal (@Preorder.toLE.{0} ENNReal (@PartialOrder.toPreorder.{0} ENNReal ENNReal.instPartialOrder))
    ...
    (@HAdd.hAdd.{0, 0, 0} ENNReal ENNReal ENNReal
      ...
      (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_1} Ω inst μ X)
      (@NumStability.HDP.Scalar.SubGaussian.PsiTwoNorm.{u_1} Ω inst μ fun (x : Ω) =>
        @MeasureTheory.integral.{u_1, 0} Ω Real Real.normedAddCommGroup
          (@InnerProductSpace.toNormedSpace.{0, 0} Real Real Real.instRCLike
            (@NormedAddCommGroup.toSeminormedAddCommGroup.{0} Real Real.normedAddCommGroup)
            (@RCLike.toInnerProductSpaceReal.{0} Real Real.instRCLike))
...
- `AuditTarget` imports: `NumStability.HDP.ContractSignatures.C_02_heq_h2_d20`, `NumStability.HDP.Scalar.SubGaussian`
...
- `NumStability.HDP.ContractSignatures.C_02_heq_h2_d20` imports: `NumStability.HDP.Scalar.SubGaussian`
...
### D025: `RCLike.toInnerProductSpaceReal`
...
### D030: `Semiring.toNonAssocSemiring`
...
### D042: `CompleteLinearOrder.toConditionallyCompleteLinearOrderBot`
...
### D043: `ConditionallyCompleteLattice.toConditionallyCompletePartialOrder`
...
### D044: `ConditionallyCompleteLinearOrder.toConditionallyCompleteLattice`
...
### D045: `ConditionallyCompleteLinearOrderBot.toConditionallyCompleteLinearOrder`
...
### D046: `ConditionallyCompletePartialOrder.toConditionallyCompletePartialOrderInf`
...
### D047: `ConditionallyCompletePartialOrderInf.toInfSet`
...
### D049: `ENNReal.instCompleteLinearOrder`
...
### `NumStability.HDP.ContractSignatures.C_02_heq_h2_d20`

Path: `lean-numerical-stability/NumStability/HDP/ContractSignatures/C_02_heq_h2_d20.lean`
SHA-256: `60c40b56a5bc678366ecb19735e5dd87774d532b6dcaea0ead0891bc1dac605f`
